...
tarkastettavasta otetut henkilötuntomerkit;

tulotarkastuksessa mahdollisesti löydetyt luvattomat aineet ja esineet.
...
tuomitun tai vangin aikaisempi rikollisuus, tuomitun tai vangin tekemän rikoksen tai tekemien rikosten laatu ja tuomitun rangaistuksen pituus;

tuomitun tai vangin sosiaaliset olosuhteet, yksilölliset tarpeet ja voimavarat;

arvio tuomitun tai vangin työ- ja toimintakyvystä;

tekijät, jotka lisäävät todennäköisyyttä syyllistyä uusiin rikoksiin;

tekijät, joilla todennäköisyyttä syyllistyä uusiin rikoksiin voidaan vähentää;

turvallisuuteen vaikuttavat tekijät.

Rangaistusajan suunnitelma sisältää:

vankeusajan keskeiset tavoitteet;

tietoja osallistumisvelvollisuuteen sisältyvän toiminnan laadusta, sisällöstä ja vaativuustasosta;

turvallisuuden ylläpitämiselle asetettavat vaatimukset;

tiedon sijoitusvankilasta;

suunnitelman mahdollisen poistumisluvan ajankohdasta ja edellytyksistä;

suunnitelman mahdollisen valvotun koevapauden ajankohdasta ja edellytyksistä;

vapauttamissuunnitelman ja valvontaan määrättävän osalta lisäksi valvontasuunnitelman.
...
vangin nimen, syntymäajan, henkilötunnuksen tai teknisen henkilötunnisteen;

vapaudenmenetyksen perusteen;

kuljetuksen määränpään;

kuljetuksen tarkoituksen;

kuljetuksen aikana huomioon otettavat turvallisuustekijät;

päiväyksen ja tiedot passituksen antajasta.
...
luvan sähköinen tai muu valvontatapa sekä muut vankilan ulkopuolella liikkumista ja yhteydenpitoa koskevat ehdot;
...
toiminnan sisältö sijoituspaikassa;

vangille asetettavat ehdot;

seuraamukset ehtojen rikkomisesta;

yhteydenpito vankilan, sijoituspaikan ja vangin koti- tai asuinkunnan välillä;

toimenpiteet sijoituksen päättyessä tai sijoituksen keskeytyessä tai purkautuessa;

muut yhteydenpitoa ja valvontaa koskevat tarpeelliset tiedot.
...
opintoluvan sähköinen tai muu valvontatapa sekä muut vankilan ulkopuolella liikkumista ja yhteydenpitoa koskevat ehdot;
...
poistumisluvan tarkoitus;

vankilasta lähtöaika ja vankilaan paluuaika;

oleskelupaikkakunta;

poistumisluvan sähköinen tai muu valvontatapa sekä muut vankilan ulkopuolella liikkumista ja yhteydenpitoa koskevat ehdot;

muut vangin käyttäytymistä koskevat ehdot;
...
rikkomuksen laatu, tapahtumapaikka ja -aika;

tiedot asiassa esitetystä selvityksestä ja viittaus rikkomuksen selvittämistä koskevaan pöytäkirjaan;

vangin lausunto;

mahdolliset muut lausunnot;

videoyhteyden tai muun vastaavan yhteydenpitotavan käyttäminen kuulemisessa;

määrätty kurinpitorangaistus tai asiassa tehty muu päätös ja sen perustelut;

kurinpitorangaistuksesta mahdollisesti tehtävä vähennys;

kurinpitorangaistuksen täytäntöönpanoaika ja -paikka.
...
henkilöntarkastuksen peruste ja suoritettu toimenpide;
...
tarkkailun aikana haltuun annetut esineet ja aineet;

ajankohta, jolloin sijoittamisesta on tehty terveydenhuoltohenkilökunnalle ilmoitus;

ajankohta, jona lääkäri tai muu terveydenhuoltohenkilökuntaan kuuluva on tutkinut tarkkailuun sijoitetun terveydentilan;

se, miten vangin terveydentilaa on seurattu.
...
valvontatapa mukaan lukien tarkkailuvaatetuksen käyttö;

eristämistarkkailun alkamis- ja päättymisajankohta;

eristämistarkkailun aikana haltuun annetut tavarat ja aineet;

ajankohta, jona sijoittamisesta on tehty terveydenhuoltohenkilökunnalle ilmoitus;

ajankohta, jona lääkäri tai muu terveydenhuoltohenkilökuntaan kuuluva on tutkinut tarkkailuun sijoitetun terveydentilan;

se, miten vangin terveydentilaa on seurattu;

tarkkailuvaatetusta käyttävän vangin WC-tiloihin pääsyä koskevan pyynnön ajankohta ja WC-tiloihin pääsyn ajankohta;
...
erillään pitämisen peruste;

täytäntöönpanopaikka;

vangin lausunto;

erillään pitämisen alkamis- ja päättymisajankohta.
...
asiakirjat, joihin vanki vetoaa oikaisuvaatimuksensa tueksi, jollei niitä ole aikaisemmin toimitettu viranomaiselle.
