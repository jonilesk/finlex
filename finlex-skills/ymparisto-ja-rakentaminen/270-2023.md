...
vastaanottopaikkoja on alueittain tasapuolisesti huomioon ottaen väestötiheys ja alueella jätelain 49 §:n 2 momentin mukaisesti järjestetty keräyspaperin kuljetus kiinteistöiltä;

vastaanottopaikat sijoitetaan tavanomaisesti käytettävien palvelujen yhteyteen, yleisesti käytettyjen kulkureittien varrelle tai muutoin siten, että ne palvelevat mahdollisimman hyvin pientalo- ja haja-asutusalueella sijaitsevia kiinteistöjä.
...
tiedot tuottajan markkinoille saattamista paperituotteista sekä arvio niiden määrästä tonneina vuodessa;

tiedot tuottajan järjestämästä keräyspaperin erilliskeräys- ja vastaanottopaikkaverkostosta, kuljetuksesta, esikäsittelystä, kierrätyksestä ja muusta hyödyntämisestä sekä loppukäsittelystä;

arvio tuottajan järjestämän jätehuollon piiriin vuosittain tulevan keräyspaperin määrästä tonneina;

selvitys keräyspaperin vastaanottoa koskevasta tiedottamisesta;

selvitys jätehuollon järjestämiseen liittyvistä sopimuksista sekä sopimuskumppaneiden ympäristöluvista ja ympäristöasioiden hallintajärjestelmistä;
...
8 §:n 1 momentin 1, 2 ja 4–10 kohdassa tarkoitettuja tietoja vastaavat tiedot tuottajayhteisöstä;

tiedot tuottajayhteisöön kuuluvien tuottajien markkinoille saattamista paperituotteista sekä arvio niiden määrästä tonneina vuodessa;

tuottajayhteisön kunkin perustajan nimi, yritys- ja yhteisötunnus sekä toimiala;

tuottajayhteisöön kuuluvien tuottajien nimi, yritys- ja yhteisötunnus sekä tuottajayhteisöön liittymispäivämäärä;

tuottajayhteisöön kuuluvien valtuutettujen edustajien nimi, yritys- ja yhteisötunnus ja tuottajayhteisöön liittymispäivämäärä sekä tiedot valtuutuksen antajasta ja niistä tuottajista, jotka muutoin vastaisivat tuottajavastuuvelvoitteista valtuutusta koskevien tuotteiden osalta;
...
7 §:ssä tarkoitettu selvitys tuottajayhteisön riittävistä taloudellisista järjestelyistä toimintansa asianmukaiseksi järjestämiseksi.
...
Suomen markkinoille saatettujen paperituotteiden valmistukseen käytetyn Suomessa valmistetun tai maahantuodun paperin määrä tonneina;

maahan tuotujen painettujen paperituotteiden määrä tonneina;

Suomessa erilliskerätyn keräyspaperin määrä tonneina;

kierrätetyn, energiana hyödynnetyn ja muulla tavoin käsitellyn keräyspaperin määrä tonneina eriteltynä käsittelylaitoksen mukaan sekä käsittelylaitoksen nimi ja sijaintipaikka;

saavutettu kierrätysaste ja selvitys ilmoitettujen tietojen arviointi- ja laskentaperusteista sekä arvio tietojen luotettavuudesta;

selvitys keräyspaperin vastaanottoa koskevasta tiedottamisesta;

tiedot omavalvontaa koskevan suunnitelman edellyttämistä toimista ja tarkastuksista;

tiedot 3 §:ssä säädetyssä vastaanoton järjestämisessä tapahtuneista muutoksista.
...
selvitys 11 §:ssä tarkoitettujen seurantatietojen kokoamisesta ja arvio tietojen luotettavuudesta sekä suunnitelma tietojen luotettavuuden kehittämiseksi;

arvio jätelain 46 §:ssä tarkoitetun tuottajan kustannusvastuun täyttymisestä;

selvitys jätelain 63 a §:ssä ja tämän asetuksen 4 §:ssä tarkoitetuista tuottajan maksuosuuksista ja niiden mukauttamisen perusteista sekä niiden seurannasta;
