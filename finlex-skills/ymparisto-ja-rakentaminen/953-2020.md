...
hakijan nimi ja yrityksen osalta sen koko;

hankkeen tai toiminnan alkamispäivä ja sen suunniteltu kesto;

hankkeen tai toiminnan toteutuspaikka ja alueen pinta-ala sekä aluetta koskeva kartta;

kuvaus alueen luonnosta;

perinnebiotoopin kunnostus- ja hoitosuunnitelma, jossa kuvataan yksilöidyt hoitotoimenpiteet ja muut toimenpiteet ja niiden toteutusaikataulu;

arvio siitä, miten toimenpiteet edistävät luonnon monimuotoisuuden suojelun tavoitteiden saavuttamista;

kunnostuksen tai hoidon toteuttamiseen mahdollisesti osallistuvat muut tahot, toteutus- ja rahoitusvastuut sekä mahdolliset tukemiseen liittyvät sopimusjärjestelyt;

muut olennaiset perinnebiotoopin kunnostus- ja hoitotoimien toteuttamiseen liittyvät seikat.
