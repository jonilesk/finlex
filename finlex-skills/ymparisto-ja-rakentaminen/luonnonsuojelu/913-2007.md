...
mekanismilailla Kioton mekanismien käytöstä annettua lakia (109/2007) ;

hankekehittäjällä yhteistoteutushankkeen toteutuksesta vastaavaa oikeushenkilöä;

osapuolikokouksen päätöksellä Kioton pöytäkirjan toimeenpanoa koskevaa osapuolten konferenssin päätöstä 9/CMP.1 (SopS 37/2006);

hankeasiakirjalla osapuolikokouksen päätöksen mukaiset tiedot sisältävää, hankkeen varmentamiseen edellytettävää, asiakirjaa;

varmentamisella osapuolikokouksen päätöksessä tarkoitettua hankkeen etukäteistä arviointia;

varmentamiskertomuksella osapuolikokouksen päätöksessä tarkoitettua hankkeen etukäteistä arviointia koskevaa kertomusta, jonka on laatinut yhteistoteutuksen ohjauskomitean hyväksymä riippumaton toiminnanharjoittaja;

kansallisilla menettelyillä osapuolikokouksen päätöksen nojalla kansallisesti valittuja menettelyjä, joita voidaan käyttää hankkeiden isäntävaltioissa, jos isäntävaltio täyttää osapuolikokouksen päätöksen asettamat kelpoisuusehdot;

yhteistoteutuksen ohjauskomitealla osapuolikokouksen päätöksen nojalla perustettua osapuolikokouksen alaista komiteaa, joka on vastuussa yhteistoteutusmekanismin toimeenpanosta ja ohjauksesta;

yhteistoteutuksen ohjauskomitean alaisella menettelyllä osapuolikokouksen päätöksessä tarkoitettua menettelyä, jota käytetään, jos isäntävaltio ei täytä osapuolikokouksen päätöksen asettamia kelpoisuusehtoja.
...
hankkeen isäntävaltio tai –valtiot;

hankkeen nimi ja hanketyyppi;

hankekehittäjän nimi ja yhteystiedot;
...
hakijan nimi, kotipaikka ja yhteystiedot;

hankkeen isäntävaltion hyväksyntä;

hankkeen hankeasiakirja.
...
hakijan voimassaoleva kaupparekisteriote;

hakijan viimeisin hyväksytty tilinpäätös;

suunnitelma hankkeen päästöjen tarkkailusta ja hankkeen tuottamien päästövähennysten todentamisesta;

selvitys siitä, ettei hanke suoraan tai epäsuorasti vähennä Euroopan yhteisön päästökauppajärjestelmään osallistuvan laitoksen kasvihuonekaasujen päästöjä;
...
oikeushenkilön nimi, yritys- tai yhteisötunnus, kotipaikka ja yhteystiedot;

oikeushenkilön hallintoelimeen kuuluvien henkilöiden, toimitusjohtajan, avoimen yhtiön sekä kommandiittiyhtiön vastuunalaisten henkilöiden nimet ja yhteystiedot;

todentamistehtävän suorittavan henkilön nimi ja syntymäaika;

mekanismilain 10 §:n 2 momentin 2–6 kohdassa säädettyjen vaatimusten arviointia varten tarvittavat asiakirjat.
...
tiedot ympäristöministeriön antamasta todentajan hyväksymisestä tai selvitys siitä, että todentaja on yhteistoteutuksen ohjauskomitean hyväksymä riippumaton toiminnanharjoittaja;

tiedot henkilöistä, jotka ovat osallistuneet todentamiseen sekä näiden tehtäväalueet ja vastuut todentamisessa;

todentamisen kohteena olleen hankkeen hanketyyppi ja sijainti;

todennettujen kasvihuonekaasupäästöjen kokonaismäärä;

päästövähennysyksiköiden määrä;

lausunnon oikaisuvaatimusohjeet.
