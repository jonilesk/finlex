...
1, toiminnat, joihin liittyy vähäinen tai kohtuullinen palovaara;

2, toiminnat, joihin liittyy huomattava tai suuri palovaara taikka joissa voi esiintyä räjähdysvaara.
...
vähintään 600 MJ/m 2, mutta enintään 1 200 MJ/m 2;
...
Erillisenä rakennuksena oleva maataloustuotteiden kuivaamo
...
Asuinrakennus, jonka päällekkäiset kerrokset kuuluvat eri asuinhuoneistoon
...
1-kerroksinen tuotanto- tai varastorakennus
...
Palovaarallisuusluokan 2 tuotanto- tai varastorakennus
...
Yli 2-kerroksinen asuinrakennus, hoitolaitos (pois lukien suljettu rangaistuslaitos), majoitusrakennus ja työpaikkarakennus 3)
...
Yli 2-kerroksinen kokoontumis- ja liikerakennus 3)
...
Yli 2-kerroksinen asuinrakennus, jonka kaikki kerrokset kuuluvat asunnoittain samaan asuinhuoneistoon 3)
...
Rakennuksen paloluokka ja palokuormaryhmät MJ/m 2
...
1–2-kerroksinen rakennus, yleensä
...
– yläpohja rakennuksessa, jossa ei ole ullakkoa ja rakenne on kantavan rungon olennainen osa 1)
...
– yksikerroksinen tuotanto- ja varastorakennus
...
– yläpohja rakennuksessa, jossa ei ole ullakkoa ja rakenne ei ole kantavan rungon olennainen osa 1)
...
Yli 2-kerroksinen rakennus, jonka korkeus on enintään 28 m, yleensä
...
– asuinrakennus, asunto, ylin kerros
...
– asuinrakennus, asunto, kaksi ylintä kerrosta 2)
...
– yli 2-kerroksinen asuinrakennus, jonka korkeus on enintään 14 m ja jonka kerrokset kuuluvat asunnoittain samaan huoneistoon
...
Yli 2-kerroksinen rakennus, jonka korkeus on yli 28 m mutta enintään 56 m
...
Yli 2-kerroksinen rakennus jonka korkeus on yli 56 m
...
Ylimmän kellarikerroksen alapuolella sijaitsevat kellarikerrokset
...
2-kerroksinen henkilöturvallisuuden kannalta vaativa rakennus ja yli 2-kerroksinen rakennus ei riittävällä luotettavuudella sorru palon eikä jäähtymisvaiheen aikana;

1–2-kerroksinen rakennus ei sorru poistumisen turvaamiseen, pelastustoimintaan ja palon hallintaan saamiseen tarvittavana aikana.
...
Olennaisten kantavien rakenteiden kestävyys palossa

Mitoituspalokuormantiheys MJ/m 2

1-kerroksinen, yleensä

Korkeus enintään 9 m

30 minuuttia ilman jäähtymisvaihetta
...
60 minuuttia ilman jäähtymisvaihetta

Q fi,k

1-kerroksinen,– majoitustila– hoitolaitos– kokoontumis- ja liiketila

Yli 50 paikkaaYli 25 paikkaaYli 250 henkilöä
...
2,0*Q fi,k, vähintään 900 MJ/m 2
...
rakennuksessa, jonka korkeus on yli 28 metriä, 28 metrin korkeuden yläpuolella porrashuonetta lukuun ottamatta enintään kaksi kerrosta voi olla samaa palo-osastoa, kuitenkin niin, että palo-osaston koko ei saa ylittää 2 400 neliömetriä, ja

yli 56 metrin korkeudella palo-osaston on rajoituttava yhteen kerrokseen, lukuun ottamatta asuinhuoneistoja, joissa sallitaan kahden kerroksen palo-osastot, ja porrashuoneita. Tällöin asuinhuoneistosta on järjestettävä pääsy uloskäytävään kummastakin kerroksesta.
...
Rakennuksen paloluokka ja kerroslukumäärä
...
– yli 2-kerroksinen, työpaikkatilat
...
– yli 2-kerroksinen, myymälätilat
...
– maan päällä erillinen autosuoja
...
Ullakot ja yläpohjan ontelot jaetaan 400 m 2 osiin.

Alapohjan ontelot jaetaan 400 m 2 osiin, jos tilan pinnat eivät vähäisiä osia lukuun ottamatta täytä D-s2, d2 -luokan vaatimuksia.
...
– yläpohja, jos osastoivuusvaatimus
...
– tuotanto- ja varastotilat, palovaarallisuusluokka 1, pinta-alaosastointi
...
– tuotanto- ja varastotilat, palovaarallisuusluokka 2, pinta-alaosastointi
...
– autosuojat, pinta-alaosastointi
...
Ullakon osastoivat seinät,pinta-alaosastointi
...
– enintään 300 m 2 palo-osasto: ravintolat, myymälät, koulut, liikuntahallit, teatterit, kirkot, päiväkodit ja päivähoitolaitokset
...
– yli 300 m 2 palo-osasto: ravintolat, koulut, liikuntahallit, teatterit, kirkot, päiväkodit ja päivähoitolaitokset
...
– yli 300 m 2 palo-osasto: myymälät, näyttelyhallit ja kirjastot
...
Autokorjaamot ja -huoltamot, autosuojat
...
– ullakot sekä yläpohjan ontelot, jotka on osastoitu alapuolisesta tilasta

ullakon tai ontelon sisäpinnat
...
– asuinrakennuksen irtaimiston säilytystä tai pyykinkuivausta varten tarkoitettu ullakko
...
– yläpohjan ontelot, joita ei ole osastoitu alapuolisesta tilasta. Vaatimus ei koske lämmöneristeen tuuletusuria.
...
Kattilahuoneet, syöttöhuoneet ja nestemäisen polttoaineen varastot
...
Kiinteän polttoaineen varastot
...
Sisäiset käytävät majoitus ja työpaikkatiloissa
...
jos lämmöneristeet ovat eristävältä osaltaan vähintään B-s1, d0 -luokkaa;

seinältä, jonka sisä- ja ulkopinnan muodostava rakennustuote liitoksineen täyttää sisäpinnan osalta B-s1, d0 -luokkavaatimuksen ja rakennusosana EI 15 -luokkavaatimuksen. Edellä mainittu ei koske asuntoja, majoitustiloja ja hoitolaitoksia;

ullakottoman 1-kerroksisen tuotanto- tai varastorakennuksen seinältä, joka sisäpinnan osalta täyttää B-s1, d0 -luokkavaatimuksen, pois lukien uloskäytävät;

ullakottoman 1-kerroksisen palovaarallisuusluokkaan 1 kuuluvan tuotanto- tai varastorakennuksen yläpohjalta, jonka sisä- ja ulkopinnan muodostava rakennustuote liitoksineen täyttää sisäpinnan osalta B-s1, d0 -luokkavaatimuksen ja rakennusosana REI 15 -luokkavaatimuksen;

ullakottoman 1-kerroksisen palovaarallisuusluokkaan 1 kuuluvan tuotanto- tai varastorakennuksen ei-kantavalta sisäkatolta, jonka ala- ja yläpinnan muodostava rakennustuote liitoksineen täyttää alapinnan osalta B-s1, d0 -luokkavaatimuksen ja rakennusosana EI 15 -luokkavaatimuksen;

asunnon pinnoilta, jos lämmöneristeet ovat eristävältä osaltaan vähintään D-s2, d2-luokkaa;

palkeilta ja pilareilta, jotka täyttävät R 30 - ja D-s2, d2 -luokkavaatimukset.
...
yli 20 prosenttia, mutta enintään 80 prosenttia ja kantavien ja osastoivien rakennusosien palonkestävyysaikaa on pidennetty 30 minuutilla;

yli 80 prosenttia ja kantavien ja osastoivien rakennusosien palonkestävyysaikaa on pidennetty 60 minuutilla.
...
Käyttötarkoitus ja paloluokka

Ulkoseinän ulkopinta

Tuuletusvälin ulkopinta

Tuuletusvälin sisäpinta

Ehdot luokkien käytölle

Yli 56 m korkea rakennus
...
P1-paloluokan enintään 56 m korkea rakennus, yleensä
...
Enintään 28 m korkea asuin- ja työpaikkarakennus, yleensä
...
– asuinrakennus, kun korjaus- ja muutostyössä on käytetty lisälämmöneristystä, joka ei täytä eristävältä osaltaan B-s1, d0 -vaatimusta ja jonka paksuus on enintään 100 mm
...
– ulkoseinän ulkopinnan osa mikäli osaa ympäröivät rakenteet suojaavat seinäpintaa palon leviämiseltä
...
Yli 14 m ja enintään 28 m korkea asuin- ja työpaikkarakennus
...
Enintään 14 m korkea asuin- ja työpaikkarakennus
...
1–2-kerroksinen ja enintään 28 m korkea tuotanto- tai varastorakennus sekä kokoontumis- ja liikerakennus
...
Yli 2-kerroksinen ja enintään 28 m korkea rakennus, yleensä
...
– asuin-, majoitus- ja työpaikkarakennus sekä kokoontumis- ja liikerakennus
...
Yli 2-kerroksinen ja enintään 14 m korkea asuinrakennus, jonka kellari ja kerrokset kuuluvat asuinnoittain samaan asuinhuoneistoon
...
Enintään kaksikerroksinen rakennus, yleensä
...
1) Jos lämmöneriste ei eristävältä osaltaan täytä B-s1, d0-vaatimusta, ulkopinnan pintarakenteiden on suojattava eristettä palolta niin, että suojaus vastaa EI 30 rakennusosaa tai tuuletusvälin sisäpinta on varustettava K 2 30, A2-s1, d0 suojaverhouksella.
...
6) Jos lämmöneriste ei eristävältä osaltaan täytä B-s1, d0-vaatimusta, ulkopinnan pintarakenteiden on suojattava eristettä palolta niin, että suojaus vastaa EI 15 rakennusosaa tai tuuletusvälin sisäpinta on varustettava K 2 10, A2-s1, d0 suojaverhouksella.
...
1–2-kerroksisessa ullakottomassa rakennuksessa;

enintään 28 metriä korkeassa rakennuksessa, jos lämmöneriste eristävältä osaltaan täyttää D-s2, d2 -luokan vaatimuksen.
...
Poistumisalueen käyttötarkoitus

Yleensä

Poistumisalue on varustettu savuilmaisuun perustuvalla paloilmoittimella tai automaattisella sammutuslaitteistolla

Poistumisalue on varustettu savuilmaisuun perustuvalla paloilmoittimella ja automaattisella sammutuslaitteistolla

Poistumisalue, josta on vain yksi uloskäytävä
...
Majoitustilat, hoitolaitosten muut tilat sekä myymälät
...
Ylimmän kerroksen lattian etäisyys sitä palvelevan porrashuoneen sisäänkäyntitasosta (m)

Poistumisalueen käyttötarkoitus

Uloskäytävien lukumäärä, vähintään

Osastoitu tai käynti turvalliselle paikalle 1)

Palolta suojattu

Palolta ja savulta suojattu
...
– asunto, alle 300 m 2 :n työpaikkatila tai alle 300 m 2 :n tuotanto- tai varastotila
...
Yli 24 ja enintään 38

Yleensä

2

– asunto tai alle 300 m 2 :n työpaikkatila

1 *

Yli 38 ja enintään 52
...
majoitusrakennuksessa, jonka huoneisiin kuljetaan suoraan ulkoa;

enintään kymmenelle hoidettavalle tarkoitetussa hoitolaitoksessa;

pienessä kokoontumis- ja liiketilassa.
...
poistumisalueella, jonka henkilömäärä on enintään 60, voi toinen uloskäytävä olla vähintään 900 millimetrin levyinen;

enintään kaksikerroksisessa asuinrakennuksessa voi olla yksi vähintään 900 millimetrin levyinen uloskäytävä;

jos olemassa olevan rakennuksen uloskäytävään asennetaan hissi tai muu tasonvaihtolaite, voi asunnon uloskäytävä olla vähintään 850 millimetrin levyinen.
...
kauanko keskimäärin kestää henkilöiden poistuminen omatoimisesti tai tilan käyttötarkoitus huomioon ottaen avustetusti palo-osastosta ja palo-osaston osista (huoneittain osiin jaettu palo-osasto),

arvio siitä, kauanko kestää vaaraa aiheutuvien olosuhteiden muodostuminen huoneessa ja palo-osastossa, ja

arvio siitä, riittääkö aika poistumiseen tai pelastamiseen vaaraa aiheuttavista olosuhteista.
...
Enintään 50 majoituspaikkaa

x

Yli 50 majoituspaikkaa

x

Hoitolaitokset, yleensäx
...
– ympärivuorokautisen käytön päiväkoditx
...
P2-paloluokan yli 2-kerroksisessa rakennuksessa mukaan luettuna parvekkeet, jotka on suunniteltu käytettäväksi varateinä. Vaatimus ei koske yli 2-kerroksista P2-paloluokan asuinrakennusta, jonka kaikki kerrokset kuuluvat asunnoittain samaan huoneistoon ja rakennuksen korkeus on enintään 14 metriä;
...
yli 2-kerroksisessa P1-paloluokan rakennuksessa, jonka korkeus on yli 56 metriä.
...
sisäänkäyntitason yläpuolisissa tiloissa, kun ylimmän kerroksen lattian etäisyys ylittää 38 metriä rakennuksen sisäänkäyntitasosta;

sisäänkäyntitason alapuolisissa tiloissa, kun kellarikerroksen lattian etäisyys ylittää 14 metriä rakennuksen sisäänkäyntitasosta ja kyseisen kellarikerroksen poistumisalueen pinta-ala on yli 800 neliömetriä.
