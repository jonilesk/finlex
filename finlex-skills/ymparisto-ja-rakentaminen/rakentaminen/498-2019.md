...
DN/OD (ulkohalkaisijaan liittyvä nimelliskoko)
...
Käyttöalueen tunnuksella tunnusta, jota käytetään putkien ja putkiyhteiden merkinnöissä ilmaisemaan niille tarkoitettua käyttöaluetta seuraavasti:
...
Jäykkyysluokalla (SN) putken tai putkiyhteen rengasjäykkyyden pyöristettyä lukuarvoa, joka liittyy määritettyyn jäykkyyteen yksikössä kilonewton/neliömetri (kN/m 2) ja ilmoittaa putken tai putkiyhteen vähimmäisrengasjäykkyyden. Kiinteistöviemärien jäykkyysluokka on SN 4 tai SN 8.

Sulaindeksillä (MFR-arvo) määrätyn muotoisesta ja kokoisesta suulakkeesta 10 minuutin aikana puristuvan muovin massaa lämpötilassa 230 celsiusastetta ja painon 2,16 kilogrammaa aiheuttamalla paineella.
...
Pitoisuus modifiointiaineen massasta

Raekoko (50 % / 98 % rakeiden massasta)

Pintakäsitelty kalsiumkarbonaatti CaCO 3

≥ 96 %, loppuosa MgCO 3, ≤4 % kokonaispitoisuus ≥ 98 %

≤ 2,5 µm / ≤ 20 µm

Magnesiumsilikaatti (talkki) MgSi 4 O 10 (OH) 2
...
Nimellinen ulkohalkaisija d n

Keskimääräinen ulkohalkaisija

Pienin seinämänpaksuus
...
Valmistajan nimi ja/tai tuotemerkki

Nimi tai tunnus

Nimelliskoko ja pienin seinämän paksuus
...
Rengasjäykkyysluokka

SN 8

Kelpoisuus kylmään ilmastoon
