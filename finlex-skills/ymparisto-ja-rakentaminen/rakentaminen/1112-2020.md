...
PE-putken liittimen nimellishalkaisijalla halkaisijaa, joka vastaa liitettävän PE-putken nimellistä ulkohalkaisijaa,

PE-putken putkijärjestelmällä järjestelmää, joka koostuu PE-putkista ja niiden liittämiseen tarkoitetuista liittimistä,

PE-putken liittimellä mekaanisesti tai sähköisesti hitsaamalla tai sähköllä lämmittämällä PE-putkeen kiinnitettävää liitintä, joka on muovia tai korroosionkestävää metallia,

PE-putken mekaanisella puristusliittimellä liitintä, joka kiinnittyy putkeen liittimen puristusosilla. Liitin tiivistyy putkeen puristusrenkaalla, O-renkaalla tai muulla vastaavalla tiivisteellä,

PE-putken mekaanisella pistoliittimellä liitintä, jossa putki kiinnitetään liittimeen työntämällä,

PE-putken sähköhitsausmuhvilla liitintä, jossa sähköllä lämmittämällä sulatetaan putki ja liitin yhteen,

PE-putken sähköhitsattavalla satulaliittimellä liitintä, jossa liitin kiristetään PE-putken ympärillä ja hitsataan sähköisesti kiinni PE-putkeen.
...
Liittimen seinämäpaksuus (E) putken seinämäpaksuuden (e min) perusteella
...
Puristuspainuma 72 tunnin jälkeen, koelämpötila 23°C

≤ 15 %

Puristuspainuma 24 tunnin jälkeen, koelämpötila 70°C

≤ 20 %

Tilavuuden muutos / paisuminen

Koeaika: 7 vrk, koelämpötila: 70 °C: väliaine: tislattu vesi
