...
maatila- tai metsätalouden harjoittaminen on yhteisön tai yhtymän toiminnan pääasiallisena tarkoituksena ja yhteisön tai yhtymän osakkaina on vain luonnollisia henkilöitä;

kuolinpesän osakkaana on vain luonnollisia henkilöitä;

maatila- tai metsätalouden harjoittaminen muodostaa pääosan säätiön toiminnasta;

yhteismetsän osuuksista tai yhteisen alueen osuuksista on vähintään puolet luonnollisten henkilöiden omistuksessa taikka yhteismetsän tai yhteisen alueen osakaskunta on muodostettu ennen 1 päivää maaliskuuta 2003 tai

maatila- tai metsätalouden harjoittaminen on niiden luonnollisten henkilöiden ja yhtiön tarkoituksena, jotka yhdessä omistavat kiinteistön ja luonnollisten henkilöiden omistusosuus kiinteistöstä on vähintään puolet.
...
maastossa tehtävät toimenpiteet työlajin tarkkuudella,

tiedot hankkeen toteuttamiseksi vaadittavista luvista ja ilmoituksista sekä

tiedot jo vireillä oleviin lupa- ja ilmoitusasioihin liittyvistä viranomaisten yhteydenotoista.
...
kohteen ja siihen sisältyvien kuvioiden pinta-ala, maaperä, kuivatusojien keskimääräinen syvyys maanpinnasta, pääpuulaji, puuston määrä ja kehitysluokka sekä taimikoissa puuston pituus,

käytettävän lannoitevalmisteen nimi ja arvioitu käyttömäärä,

lannoituksen ajankohta sekä

yksilöityinä suunnitellut vesiensuojelutoimenpiteet.
...
tien osuuksien pituudet,

tien vaikutusalueen arvioitu vuotuinen hakkuumäärä,

tien metsätalouden kuljetusten osuus,

tien vähimmäisleveys,

selvitys tien kantavuusmittauksesta tai muu selvitys, jolla on arvioitu tienrungon kerrospaksuuksien tarvetta ja

selvitys tien yhteyksistä alemmanasteiseen tieverkkoon.
...
kuvaus toimenpiteen merkityksestä ja kuvaus siitä, miten toimenpide hyödyttää vesien ja vesiluonnon hoitoa;

tiedot toteutettavien rakennelmien sijainnista, mitoista, toteutustavasta sekä niiden mitoittamisessa käytetyistä tiedoista, mukaan lukien vesimäärä sekä valuma-alueen rajat, sekä

arvio suunnitelmassa esitettyjen toimenpiteiden tehokkuudesta huomioiden alueen maastonmuodot ja maalajit.
...
kohteen ja siihen sisältyvien kuvioiden pinta-ala,

kuvioiden ravinteisuus

vesipaikkojen sijainti,

säästöpuiden määrä ja sijainti,

selvitys, että vastuuvakuutus on olemassa, ja

selvitys työnjohdon ammattitaidosta.

## 14 § Toteutusilmoitus

Toteutusilmoitukseen on merkittävä:

hanketta koskevan rahoituspäätöksen numero paitsi, jos kyse on taimikon ja nuoren metsän hoidon tuesta,

tuensaajan ja asiakirjan laatijan nimi ja yhteystiedot,

tuensaajan tilinumero,

rahoituspäätöstä koskevat toteutuneet työmäärät kiinteistöittäin sekä

kustannusten jakautuminen kiinteistöittäin, jos tuki määräytyy hyväksyttävien kustannusten perusteella.
...
Siltä osin kuin työn toteuttamisen yhteydessä on kerätty pienpuuta, toteutusilmoituksessa on ilmoitettava keruualueen pinta-ala kuvioittain, joilta pienpuuta on kerätty vähintään 35 kiintokuutiometriä hehtaaria kohden. Jos kohde sijaitsee pohjoisessa Suomessa, toteutusilmoituksessa on mainittava keruualueen pinta-ala kuvioittain, joilta pienpuuta on kerätty vähintään 25 kiintokuutiometriä hehtaaria kohden. Tiedon tulee perustua puutavaran mittauksesta annetun lain (414/2013) mukaiseen mittausasiakirjaan tai muuhun vastaavat tiedot osoittavaan asiakirjaan.
...
suunnitelman laatimisen kokonaiskustannukset.
...
piennarteiden määrät metrin tarkkuudella,

tehdyt vesiensuojelutoimenpiteet ja

hankkeen toteutuneet kokonaiskustannukset.
