...
date_published: 2015-05-13
language: fin
skill: maatalous-ja-metsa
subtopic: metsa-ja-kalastus
issued_under: ["1476/2007", "28/2014", "45/2000"]
---
...
eläinsuojalla kotieläinrakennusta, kuten hevostallia tai hevospihattoa, jossa pidetään ja hoidetaan hevosia;

hevostallilla ja tallilla eläinsuojaa, jossa hevosia pidetään karsinoissa;

hevospihatolla ja pihatolla eläinsuojaa, jossa hevosia pidetään ryhmässä ja jossa hevosilla on liikkumavapaus ulkoilu- ja makuualueelle sekä ruokintapaikalle;

hoitokarsinalla sairaalle tai hoidettavalle hevoselle tarkoitettua tilaa tallissa;

karsinalla yhdelle hevoselle tarkoitettua tilaa tallissa;

ryhmäkarsinalla usealle hevoselle tarkoitettua tilaa tallissa, jossa pidettävien hevosten tulee voida asettua yhtä aikaa makuulle;

pilttuulla hevosen kytkemiseen käytettyä pitopaikkaa tai hoitopaikkaa, jolloin kyseessä on ns. pakkopilttuu ;

ruokintapilttuulla yhdelle hevoselle eroteltua ruokintapaikkaa, johon hevonen pääse vapaasti syömään tai voidaan kytkeä syömisen ajaksi;

ulkokentällä ja ravivalmennusalueella ratsastukseen, hevosten juoksutukseen tai ajamiseen tarkoitettua pohjarakennettua aluetta;

ulkoilutarhalla hevosten vapaaseen liikkumiseen tarkoitettua aidattua jaloittelualuetta, ei kuitenkaan laajempia laidunalueita, joilla on pysyvä kasvupeite;

ulkokarsinalla tallissa sijaitsevan yksittäiskarsinan kohdalle rakennuksen ulkopuolelle rakennettua aidattua ulkotilaa;

maneesilla katettua hallia, jossa on seinät ja jossa voidaan ratsastaa ja ajaa;

hevosella hevosta, ponia, aasia ja muuta vastaavaa kavioeläintä;

lyhenteellä ppm aineen pitoisuutta miljoonaosana.
...
ilmanvaihto hevosta kohden on mitoitettava liitteen 1 taulukossa 4 esitettyjen arvojen mukaisesti;

ilmanvaihto on suunniteltava niin, ettei ilman virtausnopeus ylitä 0,25 metriä sekunnissa hevosen pitoalueella;

haitalliset kaasut ja epäpuhtaudet eivät saa eläinsuojan huoneilmassa ylittää muutoin kuin satunnaisesti seuraavia raja-arvoja: hiilidioksidi 3 500 ppm, ammoniakki 10 ppm, hiilimonoksidi 5 ppm ja orgaaninen pöly 10 milligrammaa per kuutiometri; ja

lämpöeristetyn eläinsuojan sisälämpötilan on talven aikana oltava vähintään plus kaksi celsiusastetta.
