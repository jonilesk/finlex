...
tutkimuslaitoksissa tehtäviin tieteellisiin ja tuotekehityksellisiin tarkoituksiin tehtäviin kokeisiin;

lannoitevalmisteiden kauttakulkuliikenteeseen.
...
lannoitevalmisteella lannoitteita, kalkitusaineita, maanparannusaineita, kasvualustoja,

biostimulantteja sekä niiden seoksia;

EU-lannoitevalmisteella lannoitevalmisteasetuksen 2 artiklan 2 alakohdassa tarkoitettua EU-lannoitevalmistetta;

lannoitteella ainetta tai valmistetta, joka on tarkoitettu edistämään kasvien kasvua tai parantamaan sadon laatua ja jonka vaikutus perustuu ensisijaisesti kasvinravinteisiin;

kalkitusaineella ainetta tai valmistetta, joka sisältää kalsiumin tai magnesiumin oksideja, hydroksideja, karbonaatteja tai silikaatteja ja on tarkoitettu korjaamaan maaperän happamuutta;

maanparannusaineella ainetta tai valmistetta, jonka tarkoituksena on ylläpitää tai parantaa maaperän fysikaalisia tai kemiallisia ominaisuuksia, rakennetta tai biologista aktiivisuutta;

kasvualustalla kasvien ja sienten kasvatukseen tarkoitettua ainetta tai valmistetta, johon on tai voi olla lisätty muita lannoitevalmisteita ja joka on muu kuin paikan päällä oleva maa-aines;

biostimulantilla valmistetta, joka kiihdyttää kasvin ravinteidenottoa riippumatta tuotteen ravinnesisällöstä ja jonka ainoana tarkoituksena on parantaa yhtä tai useampaa seuraavista kasvin tai kasvin ritsosfäärin ominaisuuksista: ravinteiden hyväksikäytön tehokkuus, abioottisen stressin kestävyys, laatuominaisuudet tai maaperään tai ritsosfääriin sitoutuneiden ravinteiden saatavuus;

lannoitevalmisteiden seoksella valmistetta, joka koostuu kahdesta tai useammasta lannoitevalmisteesta ja jonka jokainen seoksen osana oleva lannoitevalmiste täyttää kyseiselle tuoteluokalle asetetut vaatimukset;

lannalla sivutuoteasetuksen 3 artiklan 20 alakohdassa tarkoitettua lantaa;

jätteellä jätelain 5 §:ssä tarkoitettua jätettä;

sivutuotteella jätelain 5 a §:ssä tarkoitettua sivutuotetta;

eläimistä saatavalla sivutuotteella sivutuoteasetuksen 3 artiklan 1 alakohdassa tarkoitettuja eläimistä saatavia sivutuotteita;

haitallisella aineella, yhdisteellä ja eliöllä sellaisia lannoitevalmisteissa tai niiden ainesosissa esiintyviä aineita, yhdisteitä tai eliöitä, jotka voivat aiheuttaa terveydellistä tai muuta haittaa tai vaaraa ihmisille, eläimille, kasveille, maaperälle taikka muulle ympäristölle;

asettamisella saataville markkinoilla lannoitevalmisteen toimittamista Euroopan unionin markkinoille liiketoiminnan yhteydessä jakelua tai käyttöä varten maksua vastaan tai maksutta;

markkinoille saattamisella lannoitevalmisteen asettamista ensimmäistä kertaa saataville Euroopan unionin markkinoilla;

tuonnilla tuontia muista kuin Euroopan unionin jäsenvaltioista;

viennillä vientiä muihin kuin Euroopan unionin jäsenvaltioihin;

valmistajalla luonnollista tai oikeushenkilöä, joka valmistaa taikka suunnitteluttaa tai valmistuttaa lannoitevalmistetta ja pitää kyseistä lannoitevalmistetta kaupan omalla nimellään tai tavaramerkillään;

talouden toimijalla valmistajaa, valtuutettua edustajaa, tuojaa ja jakelijaa;

jakelijalla muuta sellaista toimitusketjuun kuuluvaa luonnollista henkilöä tai oikeushenkilöä kuin valmistajaa tai tuojaa, joka asettaa lannoitevalmisteen saataville markkinoilla;

maa- ja puutarhataloudella maatalous-, puutarha- ja peltoenergiakasvien viljelyä sekä pellon muuta maatalouskäyttöä;

viher- ja ympäristörakentamisella julkisten ja yksityisten ulkoalueiden rakentamista;

viheralueiden kunnossapidolla julkisten ja yksityisten ulkoalueiden korjaus-, hoito- ja käyttötehtäviä.
...
ehdotus uudesta ainesosasta;

selvitys 3 momentissa säädettyjen edellytysten täyttymisestä;

ehdotus soveltuvasta ainesosaluokasta;

kuvaus alkuperästä;

kuvaus tuotantoprosessista tai käsittelymenetelmästä;

selvitys keskeisestä kemiallisesta ja biologisesta koostumuksesta sekä fysikaalisista ominaisuuksista;

näytteenotto- ja analyysimenetelmät keskeisten ominaisuuksien mittaamiseksi;

hakijan yhteystiedot.

Kansalliseen lannoitevalmisteiden ainesosaluokkaan voidaan lisätä uusia ainesosia jos:

niistä valmistettu lannoitevalmiste ei aiheuta riskejä ihmisten, eläinten tai kasvien terveydelle, turvallisuudelle taikka ympäristölle;

ne parantavat kasvien kasvua tai kasvuolosuhteita taikka lannoitevalmisteen käytettävyyttä.
...
niillä ei saa johtaa käyttäjää harhaan;

niiden on oltava tarkistettavissa;

niissä ei saa esittää väitteitä, jollei niissä viitata lainsäädäntöön tai selkeästi yksilöityihin standardeihin tai järjestelmiin, joiden mukainen lannoitevalmiste on;

niissä ei saa esittää väitteitä siitä, että lannoitevalmiste ehkäisee tai hoitaa kasvitauteja tai suojelee kasveja haitallisilta organismeilta.
...
toimija on kuluvan tai kolmen arviota edeltäneen kalenterivuoden aikana toiminnassaan toistuvasti osoittanut ilmeistä piittaamattomuutta lannoitevalmisteiden turvallisuuden varmistamista tai lannoitevalmistesäännösten noudattamista kohtaan;

toimija on kuluvan tai kolmen arviota edeltäneen kalenterivuoden aikana olennaisesti laiminlyönyt veroihin, lakisääteisiin eläke-, tapaturma- tai työttömyysvakuutusmaksuihin taikka Tullin perimiin maksuihin liittyvien rekisteröitymis-, ilmoitus- tai maksuvelvollisuuksien hoitamisen; tai
...
talouden toimijan nimi ja osoite sekä muut yhteystiedot;

talouden toimijan yritys- ja yhteisötunnus tai, jos sitä ei ole, henkilötunnus tai tilatunnus;

tieto toiminnan luonteesta tai sen olennaisesta muuttamisesta;

tieto valmistettavista, tuotavista tai markkinoille asetettavista lannoitevalmisteiden tuoteluokista.
...
tiedot, joiden perusteella voidaan osoittaa tuotteen olevan laillisesti markkinoilla vastavuoroisesta tunnustamisesta annetussa asetuksessa tarkoitetulla tavalla;

tiedot valmistuksessa käytetyistä ainesosista ja niiden alkuperästä;

akkreditoidun vaatimustenmukaisuuden arviointilaitoksen myöntämä testausseloste tai sertifikaatti, joka sisältää tiedot tuotteen koostumuksesta sekä mahdollisista haitallisista aineista ja eliöistä;

kuvaus valmistusmenetelmästä;

tuoteseloste;

eläimistä saatavia sivutuotteita sisältävien lannoitevalmisteiden osalta sivutuoteasetuksen mukainen laitoksen hyväksyntänumero.
...
lannoitevalmisteen nimi ja tuoteluokka;
...
talouden toimijan nimi ja osoite sekä muut yhteystiedot toimipaikkakohtaisesti;

talouden toimijan yritys- ja yhteisötunnus tai, jos sitä ei ole, henkilötunnus tai tilatunnus;

tieto toiminnan luonteesta tai sen olennaisesta muuttamisesta;

tieto valmistettavien tai markkinoitavien lannoitevalmisteiden tuoteluokista ja EU-lannoitevalmisteiden toimintaperusteisista tuoteluokista;

tiedot valvontaviranomaisen suorittamista tarkastuksista ja niiden tuloksista sekä muut valvonnassa tarvittavat tiedot;

tiedot tämän lain ja sen nojalla annettujen määräysten ja kieltojen rikkomisesta ja valvontaviranomaisen määräämistä seuraamuksista.
...
talouden toimija laiminlyö 9 tai 11 §:ssä säädetyn velvollisuuden lannoitevalmisteiden merkitsemisestä tai pakkaamisesta;

talouden toimija laiminlyö 14 §:ssä säädetyn toimintaa koskevan ilmoitusvelvollisuuden;

lannoitevalmisteen tai lannan käyttäjä laiminlyö 6 tai 16 §:ssä säädetyn tiedoston pitämistä koskevan velvollisuuden;

talouden toimija laiminlyö 28 §:ssä säädetyn lannoitevalmisteen tuontia koskevan ilmoitusvelvollisuuden.
...
valmistuksen, jos sen valmistuksessa käytetty valmistus- tai säilytystila, valmistusmenetelmä tai -laite, valmistajan laatujärjestelmä taikka tuote ei täytä sille tässä laissa säädettyjä vaatimuksia;

käsittelyn, jos käytetty käsittely- tai säilytystila, käsittelymenetelmä tai -laite, valmistajan laatujärjestelmä taikka tuote ei täytä sille tässä laissa säädettyjä vaatimuksia;

markkinoille saattamisen tai käytön, jos lannoitevalmiste tai sen ainesosa, sen pakkaaminen taikka siitä annettavat tiedot eivät täytä tässä laissa säädettyjä vaatimuksia tai sitä käytetään sen käyttöohjeiden vastaisesti;

tuonnin, jos sen tarkastuksessa havaitaan, ettei se täytä tässä laissa säädettyjä vaatimuksia.
...
laiminlyö 6 §:ssä tai sen nojalla annetussa säännöksessä säädettyjä vaatimuksia fosforin käytöstä,

valmistaa, saattaa markkinoille, asettaa saataville markkinoilla, käyttää tai tuo lannoitevalmistetta tai ainesosaa, joka ei täytä 7 §:ssä tai sen nojalla annetuissa säännöksissä säädettyjä vaatimuksia,

rikkoo 36 §:n nojalla annettua määräystä tai 38 §:n nojalla annettua kieltoa,

rikkoo 39 §:n nojalla annettua tilapäistä rajoitusta taikka

rikkoo 41 §:n nojalla annettua uudelleenkäsittely-, hävittämis- tai palauttamismääräystä,
...
Euroopan parlamentin ja neuvoston asetus (EU) 2019/1009 (32019R1009); EUVL L 170, 25.6.2019, s. 1
