...
karitsalla vähintään kolmen kuukauden ja enintään 12 kuukauden ikäistä lammasta;

kutulla yli 12 kuukauden ikäistä poikinutta vuohta, ei kuitenkaan kääpiövuohta;

kilillä vähintään kolmen kuukauden ja enintään 12 kuukauden ikäistä vuohta;
...
josta kiinteäpohjaista alaa (m 2 /eläin)
...
mahdollisuus huonetilan tai eläimen lämpimänä pitämiseen on tarvittaessa käytettävissä;

karsinasta on näköyhteys muihin nautoihin;

hoidettavan eläimen nopea kiinnittäminen ja turvallinen käsittely on mahdollista;
