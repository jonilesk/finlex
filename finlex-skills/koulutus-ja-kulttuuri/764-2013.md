...
yleisölle avoimet kirjastot, museot ja koulutusorganisaatiot;

arkistot ja elokuva- ja äänitearkistot;

julkisen palvelun televisio- ja radioyritykset.
...
orpoteoksen nimi, teoslaji, tiedetyn tai tunnistetun tekijän nimi sekä teoksen julkaisemisen tai julkistamisen aika ja paikka;

1 kohdassa mainitut tiedot teoksista, jotka sisältyvät orpoteokseen tai muodostavat orpoteoksen olennaisen osan;

selvitysten tekopaikat ja ajankohdat;

tieto siitä, millä perusteella teoksen katsotaan olevan orpoteos;

laitoksen tiedossa olevat 8 §:stä johtuneet muutokset laitoksen käyttämien orpoteosten asemaan;

tiedot siitä, miten laitos on käyttänyt orpoteoksia 7 §:n mukaisesti;
...
valmistaa kokoelmissaan tai arkistossaan olevasta orpoteoksesta kappaleita teoksen digitointia, yleisölle välittämistä, indeksointia, luettelointia, säilyttämistä ja entistämistä varten;

välittää orpoteoksen yleisölle niin, että yleisöön kuuluvilla henkilöillä on mahdollisuus saada teos saataviinsa itse valitsemastaan paikasta ja itse valitsemanaan aikana.
...
selvityksessä käytettävistä tietolähteistä;

selvityksestä ja orpoteosten käyttämisestä annettavista tiedoista;

orpoteosten tekijäksi ilmoittautuneelta edellytettävistä tiedoista;

tietojen toimittamisesta sisämarkkinoilla toimivan yhdenmukaistamisviraston tietokantaan.
