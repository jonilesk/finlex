...
Arkistolaitoksen tietokannat;

SKS:n (Suomalaisen kirjallisuuden seura) ja SLS:n (Svenska litteratursällskapet i Finland) tietokannat;

Finna;

suomalaisten kirjallisten teosten tekijöiden toimialajärjestöjen tietokannat;

teoksen suomalainen julkaisija tai kustantaja;

oikeuksien yhteishallinnointijärjestöjen Kopiosto ry:n ja Sanasto ry:n tietokannat.
...
Kansallisgallerian tietokannat;

Museoviraston tietokannat;

Suomen valokuvataiteen museon tietokannat;

Finna;

oikeuksien yhteishallinnointijärjestö Kuvasto ry:n tietokannat.

Elokuvateosten osalta selvityksessä on käytettävä seuraavia tietolähteitä:

Kansallisen audiovisuaalisen instituutin tietokannat;

oikeuksien yhteishallinnointijärjestöjen Tuotos ry:n, Kopiosto ry:n ja Teosto ry:n tietokannat;
...
oikeuksien yhteishallinnointijärjestöjen Teosto ry:n ja Gramex ry:n tietokannat;

suomalaisten sävellysteosten tekijöiden ja esittävien taiteilijoiden toimialajärjestöjen tietokannat.

Selvityksessä on käytettävä lisäksi seuraavia ulkomaisia tietokantoja:

ARROW Plus (Accessible Registries of Rights Information and Orphan Works);
...
teoksen kansainvälinen standarditunnus;

tunnus, joka yksilöi teoksen laitoksen kokoelmissa;

teoksen kuvaus, ellei teoksen nimeä tiedetä;

oikeudenhaltijan laji.

Orpoteoksen nimen lisäksi viraston tietokantaan voidaan ilmoittaa:

teoksen kieli;

teoksen vaihtoehtoinen nimi;

teoksen nimen lyhenne tai sen käännös.
