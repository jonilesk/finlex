...
tehdä ehdotus koulun ohjesäännöksi ja opetussuunnitelmaksi sekä opetussuunnitelman vuositarkisteeksi ja toimittaa ne asianomaisille viranomaisille hyväksyttäviksi;

tarkastaa koulun tulo- ja menoarvioehdotus ja toimittaa se lääninhallitukselle, joka toimittaa sen edelleen kouluhallitukselle;

päättää koulun kalusto- ja opetusvälinehankinnoista myönnettyjen määrärahojen puitteissa;

myöntää alennus ja vapautus lukion lukukausimaksusta;

päättää aineen erilaajuisen oppimäärän ja valinnaisaineen vaihtamisesta ja kielenopetuksesta vapauttamisesta;

päättää kouluneuvostoa kuultuaan uusien kouluhallituksen hyväksymien oppikirjojen käyttöönottamisesta;

antaa kouluhallitukselle lausunto avoinna olevien virkojen ja toimien hakijoista;

ottaa tilapäiset toimihenkilöt, tuntiopettajat sekä työsopimussuhteessa oleva henkilökunta;

myöntää yli kaksi viikkoa kestävä virkavapaus viran- ja toimenhaltijalle sekä määrätä viransijainen;

määrätä jäljempänä mainitulla tavalla apulaisrehtori;

määrätä rehtorille ja apulaisrehtorille sijaiset; sekä

suorittaa kaikki muutkin tehtävät, jotka sille kuuluvat lain, asetuksen, koulun ohjesäännön tai asian laadun mukaan.
...
johtaa, ohjata ja valvoa koulun opetus- ja kasvatustyötä ja muuta toimintaa;

valmistella johtokunnan kokouksessa käsiteltävät asiat, jollei johtokunta toisin määrää;

laatia opettajien kanssa neuvoteltuaan ehdotus johtokunnalle opetussuunnitelman vuositarkisteeksi;

seurata muiden opettajien opetusta vähintään neljänä tuntina viikossa;

valvoa koulurakennuksen kaluston ja muun irtaimiston hoitoa;

kutsua tarvittaessa opettajakunta kokoon, toimia opettajakunnan kokouksen puheenjohtajana ja huolehtia opettajakunnan päätösten täytäntöönpanosta;

huolehtia kouluneuvoston päätöksen täytäntöönpanosta, jollei toisin ole säädetty tai määrätty;

myöntää koulun palveluksessa oleville virkavapautta tai vapautusta tehtävien suorittamisesta enintään kahden viikon ajaksi ja määrätä sijainen samaksi ajaksi;

myöntää oppilaalle hyväksyttävästä syystä lupa enintään viikon poissaoloon koulusta;

laatia vuosikertomus; sekä

suorittaa ne muut tehtävät jotka hänelle lain, asetuksen, koulun ohjesäännön tai asian laadun mukaan kuuluvat.
...
seurata vähintään kahtena tuntina viikossa venäjän kielen ja venäjänkielistä opetusta;

toimia venäjän kielellä opettavien opettajien ohjaajana;

valvoa venäjänkielisen opetuksen osalta opetussuunnitelmien noudattamista ja metodiikan kehittämistä;

johtaa ja valvoa venäjänkielisen oppimateriaalin laadintaa;

järjestää koulun opetus- ja koulutustoimintaan liittyviä tilaisuuksia;

johtaa ja valvoa oppilashuoltoa ja pitää yhteyttä oppilaiden koteihin;

avustaa johtajaa vuositarkisteen laadinnassa ja työrauhan ylläpitämisessä sekä tarvittaessa muissa johtajan tehtävissä; sekä

suorittaa ne muut tehtävät, jotka hänelle asetuksen, kouluohjesäännön tai asian laadun mukaan kuuluvat.
