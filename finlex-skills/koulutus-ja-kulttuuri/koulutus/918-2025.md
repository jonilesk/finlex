...
koulutuksen järjestäjän eri oppimisympäristöissä järjestämään tavoitteelliseen ja ohjattuun opiskeluun;

työpaikalla järjestettävään koulutukseen, joka perustuu oppisopimukseen tai koulutussopimukseen.
...
0,52 arvosanojen keskiarvolla 9–10;

0,56 arvosanojen keskiarvolla 8–8,99;

0,71 arvosanojen keskiarvolla 7–7,99;

1,26 arvosanojen keskiarvolla 6–6,99;

3,03 arvosanojen keskiarvolla 5–5,99;

2,0 arvosanatietojen puuttuessa.

Lähtötason perusasteen jälkeiseen koulutukseen perustuvat painokertoimet ovat:

0,25 korkeakoulututkinto;

0,5 muu kuin korkeakoulututkinto;

1,5 ei pohjakoulutusta, opiskelija opiskelee tutkintokoulutuksessa tai muussa koulutuksessa kuin 4 ja 5 kohdissa tarkoitetuissa koulutuksissa taikka sellaisessa lailla 1078/2024 muutetun ammatillisesta koulutuksesta annetun lain 8 §:n 1 kohdassa tarkoitetussa ammatillista osaamista syventävässä tai täydentävässä koulutuksessa, jonka tavoitteena ei ole tutkinnon tai sen osan suorittaminen;

2,0 ei pohjakoulutusta, opiskelija opiskelee tutkintokoulutukseen valmentavassa koulutuksessa;

3,0 ei pohjakoulutusta, opiskelija opiskelee työhön ja itsenäiseen elämään valmentavassa koulutuksessa.
...
0,19 kustannusryhmä 1;

0,55 kustannusryhmä 2;

0,89 kustannusryhmä 3;

1,16 kustannusryhmä 4;

1,64 kustannusryhmä 5;

2,45 kustannusryhmä 6;

4,19 kustannusryhmä 7.
...
tutkintokoulutuksessa 5,61;

tutkintokoulutukseen valmentavassa koulutuksessa 5,13;

työhön ja itsenäiseen elämään valmentavassa koulutuksessa 8,21.
...
ammatillisen tutkintokoulutuksen aloittaneilta opiskelijoilta (aloituskysely);

ammatillisen tutkinnon taikka tutkinnon osan tai osia suorittaneilta opiskelijoilta (päättökysely).
...
”Aikaisemmat opintoni, työkokemukseni ja muu osaamiseni selvitettiin riittävällä tavalla.”;

”Sain vaikuttaa tutkinnon osien tai opintokokonaisuuksien valintaan.”;

”Kanssani selvitettiin, tarvitsenko tukea opinnoissani.”.

Päättökyselyn väittämät ovat:

”Minulle laadittu henkilökohtainen osaamisen kehittämissuunnitelma (HOKS) mahdollisti opintojeni joustavan etenemisen.”;

”Opetustilat, välineet, työpaikat, digitaaliset ja muut oppimisympäristöni edistivät oppimistani.”;

”Olen tyytyväinen mahdollisuuksiin opiskella työpaikalla.”;
...
tutkinnon suorittaneiden opiskelijoiden päättökyselylle;

tutkinnon osan tai osia suorittaneiden opiskelijoiden päättökyselylle.
...
oppi- tai koulutussopimustyöpaikan edustajalta (työpaikkakysely);

oppi- tai koulutussopimukseen perustuvan osaamisen hankkimisen vastuulliselta työpaikkaohjaajalta (työpaikkaohjaajakysely).
...
Tällä asetuksella kumotaan ammatillisen koulutuksen rahoituksen laskentaperusteista annettu opetus- ja kulttuuriministeriön asetus (1244/2020).
