...
joka on täysi-ikäinen ja jonka toimintakelpoisuutta ei ole rajoitettu;

joka on suorittanut:

ammatillisesta aikuiskoulutuksesta annetun lain (631/1998) nojalla säädetyn tutkintorakenteen mukaisen oikeustulkin erikoisammattitutkinnon; tai

tulkin tehtävään soveltuvan korkeakoulututkinnon ja vähintään 35 opintopisteen tai sitä vastaavan laajuiset oikeustulkkauksen opinnot;

joka on antanut oikeustulkkirekisterilautakunnalle kirjallisen vakuutuksen ja jota ei hakemista edeltävän kolmen vuoden aikana ole poistettu oikeustulkkirekisteristä 7 §:n 1 momentin 3 tai 4 kohdan perusteella.
...
pyytää sitä kirjallisesti;

ei täytä 5 §:n 1 momentissa säädettyjä edellytyksiä;

on tuomioistuimen tuomiolla todettu syyllistyneen rikokseen, jonka hän on tehnyt tulkkina toimiessaan;

on muutoin tulkkina toimiessaan osoittanut olevansa ilmeisen sopimaton toimimaan oikeustulkkina.
