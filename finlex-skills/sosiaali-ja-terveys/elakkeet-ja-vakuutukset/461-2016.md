...
Liikennevakuutuskeskus on liikennevakuutuksen toimeenpanon ja kehittämisen yhteiselin. Sen tehtävistä säädetään liikennevakuutuslaissa (460/2016) ja tie- ja maastoliikenneonnettomuuksien tutkinnasta annetussa laissa (24/2001) .
...
hyväksyä sosiaali- ja terveysministeriölle annettava esitys keskuksen säännöiksi;

päättää edellisen vuoden tilinpäätöksen vahvistamisesta ja toimenpiteistä, joihin tilit antavat aihetta;

päättää vastuuvapauden myöntämisestä hallituksen jäsenille ja toimitusjohtajalle;

päättää seuraavan vuoden toimintasuunnitelmasta ja talousarviosta;

valita hallituksen jäsenet ja heidän varajäsenensä;

valita tilintarkastajat; sekä

käsitellä muut asiat, jotka ovat keskuksen sääntöjen mukaan yleiskokouksessa käsiteltäviä asioita.
...
Liikennevakuutuskeskuksen tilintarkastukseen sovelletaan muutoin tilintarkastuslakia (1141/2015) .
