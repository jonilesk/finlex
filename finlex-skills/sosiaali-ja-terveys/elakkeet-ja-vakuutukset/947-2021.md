...
lisäeläkelaitoksella lisäeläkesäätiötä ja lisäeläkekassaa;

etuusperusteisella lisäeläkejärjestelyllä järjestelyä, jossa eläke määräytyy työnantajan lupauksen mukaisesti;

maksuperusteisella lisäeläkejärjestelyllä järjestelyä, jossa eläke määräytyy suoritettujen vakuutusmaksujen ja maksujen sijoittamisesta saatujen nettotuottojen perusteella, vähennettynä kertyneiden varojen hoitokuluilla;

sijoitussidonnaisella lisäeläkejärjestelyllä maksuperusteista lisäeläkejärjestelyä, jossa eläkkeen määrä on sidottu tiettyjen sijoituskohteiden arvon kehitykseen;

lisäeläkejärjestelyllä sopimusta, muuta perustamiskirjaa ja sääntöjä, jossa määritellään lisäeläkejärjestelyssä myönnettävät lisäeläke-etuudet ja niiden myöntämisedellytykset;
...
osakkaalla työnantajaa ja yrittäjää, joka on velvollinen maksamaan lisäeläkelaitokselle vakuutusmaksua;

toiminnasta tosiasiallisesti vastaavilla henkilöillä lisäeläkelaitoksen hallituksen jäseniä ja toimitusjohtajaa;
...
edunsaajalla henkilöä, jonka oikeus eläkkeeseen tai muuhun etuuteen riippuu toisen henkilön vakuutettuna olemisesta;

etuudensaajalla henkilöä, joka nauttii lisäeläke-etuuksia;

keskeisellä toiminnolla lisäeläkelaitoksen hallintojärjestelmään kuuluvaa valmiutta suorittaa käytännön tehtäviä, joihin kuuluvat riskienhallintatoiminto, sisäisen tarkastuksen toiminto ja aktuaaritoiminto;
...
ETA-lisäeläkesäätiöllä 13 luvussa tarkoitettua lisäeläkesäätiötä, joka harjoittaa vain rajat ylittävää toimintaa tai tämän lisäksi myös muuta lisäeläkevakuutustoimintaa;

ETA-lisäeläkekassalla 13 luvussa tarkoitettua lisäeläkekassaa, joka harjoittaa vain rajat ylittävää toimintaa tai tämän lisäksi myös muuta lisäeläkevakuutustoimintaa;

ETA-lisäeläkelaitoksella ETA-lisäeläkesäätiötä ja ETA-lisäeläkekassaa;
...
toimivaltaisella viranomaisella kansallista viranomaista, joka on ETA-valtiossa nimetty hoitamaan ammatillisia lisäeläkkeitä tarjoavien laitosten toiminnasta ja valvonnasta annetun Euroopan parlamentin ja neuvoston direktiivissä (EU) 2016/2341 säädettyjä tehtäviä;
...
rajat ylittävällä toiminnalla sellaisen lisäeläkejärjestelyn hallinnointia, jossa rahoittavan yrityksen ja vakuutettujen ja etuudensaajien väliseen suhteeseen sovelletaan jonkin muun ETA- valtion kuin kotivaltion ammatillisiin lisäeläkejärjestelyihin sovellettavaa sosiaali- ja työoikeutta;
...
palveluyrityksellä yhteisöä, joka tuottaa lisäeläkelaitokselle sen toimintaan liittyviä palveluita;

luottolaitoksella luottolaitostoiminnasta annetussa laissa (610/2014) tarkoitettua luottolaitosta ja ulkomaista ETA-luottolaitosta;

velkasitoumuksella lainasaamista ja muuta saamista ja näille kertynyttä korkoa sekä joukkovelkakirjalainaa ja muita raha- ja pääomamarkkinavälineitä, ei kuitenkaan osaketta, osuutta, johdannaissopimusta eikä sellaista sitoumusta, jolla on huonompi etuoikeus kuin velallisen muilla sitoumuksilla;

sijoitusrahastolla sijoitusrahastolaissa (213/2019) tarkoitettua kotimaista sijoitusrahastoa sekä sijoitusrahastolaissa tarkoitetun muussa ETA-valtiossa kuin Suomessa toimiluvan saaneen yhteissijoitusyrityksen tarjoamaa rahastoa;

vaihtoehtorahastolla vaihtoehtorahastojen hoitajista annetussa laissa (162/2014) tarkoitettua koti- ja ulkomaista vaihtoehtorahastoa;

biometrisellä riskillä kuolemaan, työkyvyttömyyteen tai eliniän odotukseen liittyvää riskiä;
...
yrittäjät yhdessä sellaisten yrittäjien kanssa, joiden toimiala tai ammattiala on samankaltainen tai, jotka muun vastaavan seikan vuoksi muodostavat kokonaisuuden;
...
toiminimi ja, jos se ilmaistaan kahdella tai useammalla kielellä, ilmaisut edellä tarkoitetuilla kielillä;

kotipaikkana oleva Suomen kunta ja, jos lisäeläkelaitoksen keskushallinto sijaitsee muualla kuin kotipaikassa, Suomen kunta, jossa keskushallinto sijaitsee;

harjoitettava eläkevakuutustoiminta;

toimintapiiri;

ketkä ovat eläkelaitoksessa vakuutettuja;

hallituksen jäsenten ja varajäsenten lukumäärä sekä toimikausi;

hallituksen jäsenille suoritettavan palkkion peruste;

tilintarkastajien ja varatilintarkastajien toimikausi;

miten vakuutetut tulevat järjestelyn osapuoliksi ja eroavat järjestelystä sekä millä perusteella vakuutettu voidaan erottaa;

etuudet, niiden suuruus tai määräytymisperuste;

etuuksien saamisen edellytykset ja suorittamisaika;

takaako eläkelaitos biometrisen riskin, sijoitustoiminnan tuoton tai etuuksien tason;

jos vakuutetut suorittavat vakuutusmaksuja, vakuutettujen vakuutusmaksun määräytyminen, suorittamisen ajankohdat ja viivästymisestä johtuvat seuraamukset;

jos vakuutetut maksavat vakuutusmaksuja, vakuutettujen oikeudesta keskeyttää maksujen suorittaminen;

maksuperusteisessa lisäeläkejärjestelyssä vakuutettujen oikeudesta valita ja vaihtaa sijoituskohteita;

onko maksuperusteisessa lisäeläkejärjestelyssä kertyneet varat ja niille laskettavat tuotot mahdollista siirtää toiseen vakuutuslaitokseen;

säilyttääkö ja missä määrin henkilö, jonka vakuutussuhde on päättynyt ennen eläkkeeseen tai muuhun etuuteen oikeuttavan tapahtuman sattumista, itse ja hänen edunsaajansa oikeuden eläkkeeseen tai muuhun etuuteen;

eläkelaitoksen varojen ja vastuiden jakautumisesta eläkelaitosta purettaessa.

Lisäksi säännöissä tulee olla:

tieto siitä, että vakuutetuilla ja heidän edunsaajillaan on oikeus lisäeläkkeeseen tai muuhun etuuteen työsopimuslain (55/2001) 1 luvun 10 §:ssä tarkoitetussa liikkeen luovutustilanteessa;

tieto siitä, että eläkelaitos toimittaa vakuutetuille, eläkkeen- ja muun etuuden saajille ja edunsaajille 7 luvussa tarkoitetut tiedot, sekä tieto siitä, miten ja milloin tiedot toimitetaan;

tieto vakuutettujen, eläkkeen- ja muun etuudensaajien ja edunsaajien käytettävissä olevista oikeusturvakeinoista.

Lisäeläkekassan säännöissä tulee sen lisäksi, mitä 1 momentissa säädetään määrätä:

miten kutsu kassankokoukseen toimitetaan;

miten osakkaiden äänioikeus ja äänimäärät jakautuvat kassankokouksessa;

jos kassalla on edustajisto, edustajiston jäsenten ja varajäsenten toimikausi ja valitsemistapa sekä jäsenille suoritettavan palkkion peruste;

miten osakaskohtainen vakuutusmaksu määräytyy ja seuraamukset maksun viivästymisestä;

miten osakas eroaa ja millä perusteella osakas voidaan erottaa kassasta.

Lisäeläkesäätiön säännöissä tulee sen lisäksi, mitä 1 momentissa säädetään, määrätä:

hallituksen jäsenten ja varajäsenten valitsemistapa;

noudattaako eläkesäätiö, jossa on useita osakkaita, kirjanpidossaan tasaavaa vai osakaskohtaista järjestelmää;

miten osakkaiden osuus 5 luvun 15 §:ssä tarkoitetusta ylikatteesta lasketaan tasaavaa kirjanpitojärjestelmää noudattavassa eläkesäätiössä.
...
huomattavan riskin, ettei lisäeläkelaitos noudata merkittävää lakisääteistä vaatimusta, ja tämä voisi vaikuttaa merkittävästi vakuutettujen ja etuudensaajien etuihin;

toimintonsa suorittamisen yhteydessä lisäeläkelaitokseen tai sen toimintaan sovellettavan lain, asetuksen tai hallinnollisen määräyksen merkittävän aineellisen rikkomisen.
...
arvioi vakuutusteknisen vastuuvelan laskennassa käytettävien menetelmien ja mallien sekä näitä varten tehtyjen olettamien asianmukaisuuden;
...
ilmoittaa lisäeläkelaitoksen hallitukselle vakuutusteknisen vastuuvelan laskennan luotettavuudesta ja asianmukaisuudesta;

antaa lausunnon lisäeläkelaitoksen yleisestä vakuutuspolitiikasta, jos sillä on käytössä tällainen politiikka;

antaa lausunnon lisäeläkelaitoksen vakuutusjärjestelyjen asianmukaisuudesta, jos sillä on käytössä tällaisia järjestelyjä;
...
kuvaus siitä, kuinka riskienarviointi on sisällytetty lisäeläkelaitoksen johto-, hallinnointi- ja päätöksentekoprosesseihin;

arviointi riskienhallintajärjestelmän tehokkuudesta;

kuvaus siitä, kuinka lisäeläkelaitos estää eturistiriidat lisäeläkelaitoksessa vakuuttavan työnantajan kanssa, jos lisäeläkelaitos ulkoistaa keskeisiä toimintoja edellä tarkoitetulle työnantajalle 6 §:n 3 momentin mukaisesti;

arviointi lisäeläkelaitoksen kokonaisrahoitustarpeesta ja tervehdyttämissuunnitelmasta, jos lisäeläkelaitoksella on tervehdyttämissuunnitelma;
...
laadullinen arviointi mekanismeista, joilla suojataan eläke-etuuksia mukaan lukien lisäeläkelaitosta tai vakuutettuja ja etuudensaajia hyödyttävät takeet, sopimukset ja muu lisäeläkelaitoksessa vakuuttavan työnantajan antama taloudellinen tuki, vakuutus- ja jälleenvakuutustoiminnan aloittamisesta ja harjoittamisesta (Solvenssi II) annetun Euroopan parlamentin ja neuvoston direktiivin 2009/138/EY soveltamisalaan kuuluvan vakuutusyrityksen antama vakuutus tai jälleenvakuutus tai eläkkeiden suojajärjestelmä;

laadullinen arviointi operatiivisista riskeistä;

kun ympäristö, sosiaaliset ja hallintotapaan liittyvät tekijät otetaan huomioon sijoituspäätöksissä, arviointi uusista tai kehittymässä olevista riskeistä mukaan lukien arviointi ilmastonmuutokseen, luonnonvarojen käyttöön ja ympäristöön liittyvistä riskeistä sekä sosiaalisista riskeistä ja sääntelyn muuttumisen aiheuttamaan omaisuuserien arvonalenemiseen liittyvistä riskeistä.
...
lisäeläkelaitoksen hallintojärjestelmän laadun heikkenemiseen;
...
tuettava lisäeläkelaitoksen turvaavaa, varovaista ja tehokasta johtamista ja hallinnointia;

vastattava lisäeläkelaitoksen hallinnoimien lisäeläkejärjestelyjen vakuutettujen ja etuudensaajien pitkän aikavälin etuja;
...
vastuuvelka 5 luvun säännöksiä noudattaen laskettuun arvoon;
...
lisäeläkelaitosten lisäeläketoimintaa vastaavien varojen yleinen tuottotaso.
...
suoritetuista vakuutusmaksuista johtuvan vakuutusturvan määrälle;

määrälle, jonka vakuutettu voi siirtää toiseen lisäeläketurvaa järjestävään laitokseen, jos järjestelyyn sisältyy siirto-oikeus;

vapaakirjalle, joka vastaa vakuutetun omia maksuosuuksia vastaavaa osaa kertyneistä varoista.
...
lisäeläkekassan maksettu pohjarahasto ja maksettu takuupääoma;
...
lisäeläkelaitoksen hakemuksesta ja Finanssivalvonnan suostumuksella taseen omaisuuden käypien arvojen ja kirjanpitoarvojen positiivinen erotus siltä osin kuin sitä ei voida pitää luonteeltaan poikkeuksellisena;

5 momentissa säädetyin rajoituksin, lisäeläkekassan hakemuksesta ja Finanssivalvonnan suostumuksella puolet maksamatta olevasta pohjarahaston ja takuupääoman yhteismäärästä, kun 25 prosenttia pohjarahaston ja takuupääoman yhteismäärästä on maksettu;

5 momentissa säädetyin rajoituksin, lisäeläkesäätiön hakemuksesta ja Finanssivalvonnan suostumuksella puolet maksamatta olevasta peruspääoman määrästä, kun 25 prosenttia lisäeläkesäätiön peruspääomasta on maksettu.
...
johdannaissopimuksista lisäeläkelaitokselle koituva mahdollinen enimmäistappio.
...
selvitys käytetyistä sijoitusriskien mittaamis- ja hallintamenetelmistä sekä strategiasta, jota noudattaen eläkelaitos on jakanut sijoittamansa varat ottaen huomioon vastuuvelan luonteen ja keston;

selvitys prosesseista riskien hallitsemiseksi;

selvitys ympäristön sekä sosiaalisten ja hallintotapaan liittyvien tekijöiden huomioon ottamisesta sijoituspolitiikassa;

selvitys lisäeläkelaitoksen luottoarviointiprosessista sekä sen riittävyydestä ottaen huomioon lisäeläkelaitoksen toiminnan koko, luonne, laajuus ja monitahoisuus.
...
velkasitoumuksiin perustuvia lainasaamisia ja muita saamisia;

osakkeita ja muita tuotoltaan vaihtelevia omistusosuuksia sekä pääomalainoja ja muita sitoumuksia, joilla on heikompi etuoikeus kuin yhteisön muilla sitoumuksilla;

osuuksia sijoitus- ja vaihtoehtorahastoissa;

kiinteistöjä, rakennuksia vuokraoikeuksineen ja kiinteään omaisuuteen kohdistuvia sopimukseen tai muuhun oikeustoimeen perustuvia vuokra- ja käyttöoikeuksia tai muita vastaavia oikeuksia, jotka on kirjattu erityisinä oikeuksina kiinteistörekisteriin;

osakkeita ja osuuksia kiinteistöyhteisöissä;

rakennusaikaisia saamisia kiinteistöyhteisöltä, joka omistaa 5 ja 6 kohdassa tarkoitettuja varoja ja jossa katteen haltijana olevalla lisäeläkelaitoksella on määräämisvalta;

muita arvopapereita;

vakuutusmaksusaamisia osakkailta sekä muita saamisia jälleenvakuuttajilta kuin 5 §:n 1 momentin 1 kohdassa tarkoitettuja jälleenvakuuttajien osuuksia;

verotuksessa vahvistettuja verosaamisia ja muita saamisia valtioilta sekä muilta julkisyhteisöiltä;

saamisia takuurahastoilta;

muita kuin 5 kohdassa tarkoitettuja aineellisiin hyödykkeisiin luettavia varoja;

rahaa ja pankkisaamisia sekä talletuksia luottolaitoksissa ja muissa laitoksissa, joilla on oikeus vastaanottaa talletuksia;

korkosaamisia, vuokrasaamisia, muita tulojäämiä ja muita vastaavia siirtosaamisia sekä menoennakoita.
...
velkasitoumuksilla, joissa velallisena tai takaajana on ETA-valtio, Ahvenanmaan maakunta tai kansainvälinen yhteisö, jonka jäsenistä ainakin yksi on ETA-valtio;

velkasitoumuksilla, joissa velallisena tai takaajana on ETA-valtiossa sijaitseva kunta, kuntayhtymä, julkisyhteisönä toimiva seurakunta tai muu sellainen niihin rinnastettava alueellinen julkisyhteisö, jolla tai jonka jäsenillä on veronkanto-oikeus;

velkasitoumuksilla, joissa velallisena tai takaajana on ETA-valtiossa toimiluvan saanut luottolaitos tai vakuutusyhtiö;

talletuksilla ETA-valtiossa toimiluvan saaneessa luottolaitoksessa;

velkasitoumuksilla, joissa velallisena on yhteisö, jonka kotipaikka on ETA-valtiossa ja jonka osakkeilla käydään kauppaa säännellyllä markkinalla;

Euroopan investointipankin liikkeelle laskemilla tai takaamilla sijoituksilla Euroopan strategisten investointien rahastoon, eurooppalaiseen pitkäaikaissijoitusrahastoon, eurooppalaiseen yhteiskunnalliseen yrittäjyyteen erikoistuneeseen rahastoon tai eurooppalaiseen riskipääomarahastoon;

velkasitoumuksilla, joiden panttivakuutena on 3 kohdassa tarkoitetun vakuutusyhtiön antamia henkivakuutuksia tai 1, 2 ja 5 kohdassa tarkoitettuja velkasitoumuksia.
...
joissa velallisena on yhteisö, jonka kotipaikka on ETA-valtiossa ja jonka osakkeilla käydään kauppaa säännellyllä markkinalla taikka monenkeskisessä kaupankäyntijärjestelmässä tai organisoidussa kaupankäyntijärjestelmässä;

joilla käydään kauppaa säännellyllä markkinalla taikka monenkeskisessä kaupankäyntijärjestelmässä tai organisoidussa kaupankäyntijärjestelmässä;

joiden vakuudeksi on voimassa kiinnitys 7 §:n 1 momentin 5 kohdassa tarkoitettuun ETA-valtiossa sijaitsevaan omaisuuteen taikka joiden vakuutena on 7 §:n 1 momentin 6 kohdassa tarkoitettuja osakkeita tai osuuksia kiinteistöyhteisöissä, joiden kotipaikka on ETA-valtiossa;

joiden panttivakuutena on 1 tai 2 kohdassa tarkoitettuja velkasitoumuksia.
...
kaupankäynnin kohteena säännellyllä markkinalla taikka monenkeskisessä kaupankäyntijärjestelmässä tai organisoidussa kaupankäyntijärjestelmässä olevilla osakkeilla, osuuksilla ja muilla yhteisöjen liikkeeseen laskemilla arvopapereilla lukuun ottamatta 9 §:ssä tarkoitettuja velkasitoumuksia;

sellaisten yhteisöjen osakkeilla, osuuksilla ja muilla näiden liikkeeseen laskemilla arvopapereilla, joilla on kotipaikka ETA-valtiossa, lukuun ottamatta 9 §:ssä tarkoitettuja velkasitoumuksia;

1 tai 2 kohdassa tarkoitettujen yhteisöjen ottamilla pääomalainoilla ja muilla sitoumuksilla, joilla on heikompi etuoikeus kuin yhteisön muilla sitoumuksilla;

velkasitoumuksilla, joiden panttivakuutena on tässä pykälässä tarkoitettuja arvopapereita.
...
muut saamiset jälleenvakuuttajilta kuin 5 §:n 1 momentin 1 kohdassa tarkoitetut jälleenvakuuttajien osuudet yhteensä 25 prosenttia;

verotuksessa vahvistetut tai muut vastaavat saamiset ETA-valtiossa sijaitsevalta julkisyhteisöiltä yhteensä 25 prosenttia, joista saaminen muulta yksittäiseltä julkisyhteisöltä kuin ETA-valtiolta voi olla enintään10 prosenttia;

12 §:n 2 momentissa tarkoitetut sijoitusrahastojen ja vaihtoehtorahastojen osuudet yhteensä 25 prosenttia siten, että yhden sijoitusrahaston osuus voi olla enintään 5 prosenttia;

osakkeet ja osuudet ja muut yhteisöjen liikkeeseen laskemat arvopaperit, joilla käydään kauppaa muussa valtiossa kuin ETA- tai OECD-valtiossa säänneltyä markkinaa vastaavalla markkinalla, enintään 15 prosenttia;

muu kuin 7 §:n 1 momentin 5–7 kohdassa tarkoitettu omaisuus, enintään 10 prosenttia.
...
velkasitoumukset, joissa velallisena on lisäeläkesäätiön osakas ja joilla ei ole osakkaasta riippumatonta 7–10 §:n mukaista vakuutta yhteensä 25 prosenttia;

lisäeläkesäätiössä osakkaana olevan yhteisön osakkeet ja osuudet, jos niillä käydään kauppaa säännellyllä markkinalla, enintään 10 prosenttia.
...
sitoumukset, joilla on heikompi etuoikeus kuin velallisen muilla sitoumuksilla;

joukkovelkakirjat;

muut sijoitusvälineet, joilla on pitkän aikavälin sijoitushorisontti.

Mitä 2 momentissa säädetään, ei kuitenkaan sovelleta:

joukkovelkakirjoihin, joista 8 §:n 1 momentin 1–3 kohdan mukaan vastaa valtio, kunta, vakuutusyhtiö, luottolaitos tai muu niihin rinnastettava yhteisö;

7 §:n 1 momentin 5–7 kohdassa tarkoitettuun omaisuuteen.
...
velkasitoumuksiin, joissa 8 §:n 1 momentin 1–3 kohdan mukaan velallisena on valtio, kunta, vakuutusyhtiö, luottolaitos tai muu niihin rinnastettava yhteisö;

joukkovelkakirjalainoihin ja muihin pääomamarkkinavälineisiin.
...
saman yhteisön osakkeisiin, muihin niihin rinnastettaviin arvopapereihin sekä saman yhteisön pääomalainoihin;

saman velallisen antamiin velkasitoumuksiin;

eri velallisten antamiin velkasitoumuksiin, joiden vakuutena on sijoituksia yhteen yhteisöön tai yhden yhteisön antama takaus tai takausvakuutus.

Mitä 1 momentissa säädetään, ei sovelleta:

velkasitoumuksiin, joissa velallisena tai takaajana on ETA-valtio ja joissa velan, velallisen tai takaajan luottoluokitus kuuluu eläkelaitoksen vakavaraisuusrajan laskemisesta ja sijoitusten hajauttamisesta annetun lain 11 §:ssä tarkoitettuun luottoluokkaan 1;

velkasitoumuksiin, joissa velallisena on Ahvenanmaan maakunta tai sellainen kansainvälinen yhteisö, jonka jäsenistä ainakin yksi on ETA-valtio, jonka luottoluokitus kuuluu eläkelaitoksen vakavaraisuusrajan laskemisesta ja sijoitusten hajauttamisesta annetun lain 11 §:ssä tarkoitettuun luottoluokkaan 1;

12 §:n mukaisiin osuuksiin sijoitusrahastoissa tai vaihtoehtorahastoissa.
...
siitä, että jotkin 7 §:n mukaiset katteeseen hyväksyttävät varat arvostetaan niiden käyvästä arvosta poikkeavasti, jos se on omaisuuslajin luonteeseen liittyvän käyvän arvon suuren vaihtelun vuoksi tai muusta syystä välttämätöntä;

11 §:n 2 momentin 5 kohdassa tarkoitettujen varojen osalta vastuuvelan katteeksi hyväksyttävistä varoista, jos se on näiden varojen erityisen riskillisyyden vuoksi välttämätöntä.
...
toteutettava lisäeläkelaitoksen toimeksiannot, jos ne eivät ole ristiriidassa lain tai lisäeläkelaitoksen sääntöjen kanssa;

varmistettava, että lisäeläkelaitoksen varoja koskeviin toimiin liittyvät maksut suoritetaan lisäeläkelaitokselle yleisesti käytössä olevia määräaikoja noudattaen;
...
pidettävä kirjaa, jonka avulla lisäeläkelaitos kykenee yksilöimään kaikki varat jatkuvasti ja viipymättä;
...
miten lisäeläkelaitos käy vuoropuhelua 1 momentissa tarkoitettujen kohdeyhtiöiden, niiden muiden osakkeenomistajien ja sidosryhmien kanssa;

miten lisäeläkelaitos tunnistaa, ehkäisee ja estää vaikuttamiseen liittyviä eturistiriitoja.
...
tiedot siitä, miten lisäeläkelaitos valvoo omaisuudenhoitajalle, rahastoyhtiölle tai vaihtoehtorahaston hoitajalle aiheutuvia salkun kiertonopeuden kustannuksia ja määrittelee tavoitteeksi asetetun salkun kiertonopeuden tai kiertonopeuden rajat sekä valvoo niitä;
...
eläke-etujen laajuuteen;

eläke-etujen saamiseen liittyviin edellytyksiin ja valintamahdollisuuksiin;

eläkkeen yhteensovittamiseen lakisääteisen eläkkeen ja muiden etuuksien kanssa.
...
vakuutettujen maksuosuuksien määräytymisperusteisiin;

maksujen laiminlyönnin seuraamuksiin;

vakuutettujen oikeuteen keskeyttää maksujen suorittaminen;

järjestelystä eroamisen vaikutuksiin;

vakuutettujen oikeuteen vaihtaa sijoituskohteita työsuhteen aikana ja sen jälkeen;

siihen, onko järjestelyyn kertyneet varat mahdollista siirtää toiseen vakuutuslaitokseen.
...
lisäeläkelaitoksen nimi ja osoite sekä vakuutetun lisäeläkejärjestelyn tunnistetiedot;
...
tiedot lisäeläkelaitoksessa vakuuttavan työnantajan ja vakuutetun lisäeläkejärjestelyyn suorittamista maksuista vähintään viimeisten 12 kuukauden ajalta ottaen huomioon lisäeläkejärjestelyn erityisluonne;
...
lisäeläkelaitoksen nimi ja ETA-valtio, jossa se on rekisteröity tai hyväksytty, sekä kyseisen ETA-valtion toimivaltaisen viranomaisen nimi;
...
vakuutetuille tarjolla olevat lisäeläke-etuuksien ottamista koskevat vaihtoehdot;

jos vakuutetuilla on oikeus lisäeläkeoikeuksien siirtoon, tiedot tällaiseen siirtoon liittyvistä järjestelyistä.
...
lisäeläkelaitoksen tilinpäätös ja toimintakertomus ja, jos lisäeläkelaitos vastaa useammasta kuin yhdestä lisäeläkejärjestelystä, kunkin lisäeläkejärjestelyn tilinpäätös ja toimintakertomus;

lisäeläkelaitoksen sijoituspolitiikan periaatteita koskeva selvitys;

tieto lisäeläkelaitoksen säännöistä, jotka koskevat lisäeläkeoikeuksien siirtämistä toiseen lisäeläkelaitokseen siinä tapauksessa, että työsuhteen päättymisestä johtuen vakuutussuhde päättyy.
...
ne on asetettu mahdollisten vakuutettujen, vakuutettujen ja etuudensaajien saataville veloituksetta sähköisessä muodossa tai paperijäljennöksenä.
...
sulautumiseen osallistuvien lisäeläkelaitosten toiminimet, yritys- ja yhteisötunnukset ja kotipaikat;

selvitys sulautumisen syistä;

absorptiosulautumisessa ehdotus vastaanottavan lisäeläkelaitoksen mahdollisesta sääntömuutoksesta sekä kombinaatiosulautumisessa ehdotus perustettavan lisäeläkelaitoksen säännöiksi ja ehdotus siitä, miten perustettavan lisäeläkelaitoksen toimielinten jäsenet valitaan;

selvitys sulautuvan lisäeläkelaitoksen vastuuvelan ja muiden velkojen sekä varojen siirtymisestä vastaanottavalle lisäeläkelaitokselle;

selvitys siitä, että vastaanottava lisäeläkelaitos täyttää sulautumisen jälkeen 5 ja 6 luvussa säädetyt vaatimukset;

selvitys sulautuvan lisäeläkelaitoksen varoista, veloista ja omasta pääomasta ja niiden arvostamiseen vaikuttavista seikoista, sulautumisen suunnitellusta vaikutuksesta vastaanottavan lisäeläkelaitoksen taseeseen sekä sulautumiseen sovellettavista kirjanpidollisista menetelmistä;

ehdotus sulautumisen täytäntöönpanon suunnitellusta rekisteröintiajankohdasta, joka saa olla enintään kuuden kuukauden kuluttua sulautumissuunnitelman tekemisestä;
...
kunkin sulautumiseen osallistuvan lisäeläkelaitoksen hallituksen jäsenten ja toimitusjohtajan vakuutus siitä, että sulautumisessa on noudatettu tämän lain säännöksiä;

selvitys siitä, että vastaanottava lisäeläkelaitos täyttää 6 luvussa säädetyt vaatimukset vastuuvelan kattamisesta;

hallituksen jäsenen tai toimitusjohtajan todistus eläkesäätiö- ja eläkekassalain 10 luvun 6 §:n 1 momentissa tarkoitettujen ilmoitusten lähettämisestä;

sulautumiseen osallistuvien lisäeläkelaitosten sulautumista koskevat päätökset.
...
jakautuvan lisäeläkelaitoksen toiminimi, yritys- ja yhteisötunnus tai vastaavat yksilöintitiedot sekä kotipaikka;

selvitys jakautumisen syistä;

laskelma jakautuvan lisäeläkelaitoksen vastuuvelasta ja varoista;

selvitys jakautuvan lisäeläkelaitoksen vastuuvelan sekä varojen ja velkojen jakamisesta;

jos jakautuvalla lisäeläkelaitoksella on tasoitusmäärä, selvitys tasoitusmäärän jakamisesta;

selvitys siitä, että jakautumiseen osallistuvat lisäeläkelaitokset täyttävät jakautumisen jälkeen 6 luvussa säädetyt vaatimukset;

ehdotus perustettavan lisäeläkelaitoksen säännöiksi;

perustettavan lisäeläkelaitoksen perustajien toiminimet, yritys- ja yhteisötunnukset tai vastaavat yksilöintitiedot, kotipaikat sekä perustettavan lisäeläkelaitoksen hallituksen jäsenet;

ehdotus jakautumisen täytäntöönpanon suunnitellusta rekisteröintiajankohdasta;

ehdotus mahdollisiksi muiksi jakautumisen ehdoiksi.
...
luovuttavan ja vastaanottavan lisäeläkelaitoksen toiminimet, yritys- ja yhteisötunnukset sekä kotipaikat;

selvitys vakuutuskannan luovutuksen syystä;

tarvittaessa ehdotus vastaanottavan lisäeläkelaitoksen sääntöjen muuttamiseksi;

selvitys siitä, mitä on sovittu luovutettavaan vakuutuskantaan liittyvästä osakkuudesta, jos vastaanottava yhtiö on keskinäinen vakuutusyhtiö;

selvitys luovutettavasta vakuutuskannasta ja sitä vastaavina varoina luovutettavasta omaisuudesta;

ehdotus vakuutuskannan luovuttamisesta mahdollisesti suoritettavasta vastikkeesta ja sen ehdoista;

jos luovuttavalla lisäeläkelaitoksella on tasoitusmäärä, selvitys mahdollisesti siirtyvästä tasoitusmäärästä;

selvitys siitä, että luovuttava ja vastaanottava lisäeläkelaitos täyttävät luovutuksen jälkeen 6 luvussa säädetyt vaatimukset;

selvitys tai ehdotus vakuutuskannan luovuttamiseen ja vastaanottamiseen osallistuvien lisäeläkelaitosten hallituksen jäsenelle, toimitusjohtajalle ja tilintarkastajalle annettavista erityisistä eduista ja oikeuksista;

ehdotus suunnitellusta vakuutuskannan ja sitä vastaavien varojen luovutusajankohdasta;

ehdotus mahdollisiksi muiksi vakuutuskannan luovutuksen ehdoiksi.
...
kunkin vakuutuskannan luovuttamiseen osallistuvan lisäeläkelaitoksen tai vakuutusyhtiön viimeksi päättyneen tilikauden tilinpäätös, toimintakertomus ja tilintarkastuskertomus;

hallituksen selostus tilinpäätöksen ja toimintakertomuksen jälkeisistä lisäeläkekassan asemaan olennaisesti vaikuttavista seikoista sekä seikoista, joilla saattaa olla merkitystä harkittaessa vakuutuskannan luovuttamista koskevan sopimuksen hyväksymistä;

vastaanottavan lisäeläkelaitoksen säännöt ja tarvittaessa niitä koskeva vastuunsiirtämisestä johtuva muutosehdotus.
...
jollei luovutus loukkaa vakuutettuja etuja;

jollei luovutuksen voida katsoa vaarantavan vakuutustoiminnan tervettä kehitystä; ja

jos Finanssivalvonta on hyväksynyt vastaanottavan lisäeläkelaitoksen 3 §:n 2 momentin 3 kohdassa tarkoitetun sääntöjen muuttamisen.
...
jos lisäeläkekassan tilinpäätös on osoittanut alijäämää tai jos mahdollinen perustamispääoma on ollut lisäeläkekassan säännöissä vahvistettua pienempi, eikä alijäämää ole katettu taikka perustamispääomaa täytetty kahden seuraavan tilikauden aikana;

jos lisäeläkesäätiö ei täytä 5 luvun 11 §:ssä säädettyjä vaatimuksia;

jos on käynyt ilmeiseksi, että lisäeläkelaitos ei ole kattanut 5 luvun 2 §:n 3 momentissa tarkoitettua maksuperusteisen lisäeläkejärjestelyn vastuuvelkaa 6 luvussa säädetyllä tavalla;

jos lisäeläkelaitos ei ole toteuttanut 5 luvun 10 §:ssä tarkoitettua suunnitelmaa katevajauksen kuolettamiseksi säädetyssä määräajassa;

jos lisäeläkelaitos ei ole toteuttanut 5 luvun 25 §:ssä tarkoitettua taloudellisen aseman tervehdyttämissuunnitelmaa tai lyhyen aikavälin rahoitussuunnitelmaa säädetyssä määräajassa;

jos lisäeläkelaitoksen kaikki osakkaat lopettavat sen toimintansa, jonka piirissä lisäeläkelaitoksessa vakuutetut henkilöt toimivat;

jos lisäeläkekassa on sen sääntöjen mukaan purettava; taikka

jos Finanssivalvonta on määrännyt lisäeläkelaitoksen purettavaksi Finanssivalvonnasta annetun lain (878/2008) 26 §:n perusteella.
...
turvataanko jäljelle jäävien vakuutettujen ja etuudensaajien asema pitkällä aikavälillä siirrettäessä lisäeläkejärjestely osittain 1 §:n 2 momentissa tarkoitetulla tavalla;

ovatko vakuutettujen ja etuudensaajien yksilölliset etuudet vähintään samat siirron jälkeen;

ovatko siirrettävää lisäeläkejärjestelyä vastaavat varat riittävät ja asianmukaiset kattamaan siirrettävän vastuun, vakuutusteknisen vastuuvelan ja muut velvoitteet ja oikeudet 6 luvussa säädetyllä tavalla.
...
todiste 6 §:n 2 momentissa tarkoitetuista vakuutettujen, etuudensaajien ja rahoittavan yrityksen suostumuksesta;
...
onko lupaa hakeva lisäeläkelaitos toimittanut kaikki 7 §:n 1 momentissa tarkoitetut tiedot;

ovatko lisäeläkelaitoksen hallinnollinen rakenne ja taloudellinen tila, johtajien hyvä maine ja ammatillinen pätevyys ja kokemus aiotulle siirrolle asetettujen vaatimusten mukaisia;

turvataanko lisäeläkelaitoksen vakuutettujen ja etuudensaajien sekä niihin siirrettyjen vakuutettujen ja edunsaajien pitkän aikavälin edut siirron aikana ja sen jälkeen;

onko lisäeläkelaitoksen vastuuvelka täysin katettu siirron ajankohtana, jos siirto johtaa rajat ylittävään toimintaan;

ovatko siirrettävät varat riittävät ja asiamukaiset kattamaan siirrettävän vastuun, vakuutustekninen vastuuvelka mukaan lukien, sekä muut velvoitteet ja oikeudet tässä laissa säädetyllä tavalla.
...
5 luvussa säädettyä vakuutusteknistä vastuuvelkaa ja sen rahoittamista, lisäeläkelaitoksen omia varoja, käytettävissä olevaa omien varojen vähimmäismäärää ja vaadittua omien varojen vähimmäismäärää;

6 luvun sijoittamista ja omaisuudenhoitoa sekä varojen säilyttämistä koskevia säännöksiä;

3 luvun hallintojärjestelmää ja johtoa koskevia säännöksiä;
...
täyttääkö lisäeläkelaitoksen hallintojärjestelmä 3 luvussa säädetyt laadulliset vaatimukset;

lisäeläkelaitoksen toiminnan riskejä ja sen kykyä arvioida ja hallita näitä riskejä.
...
riskien ja etujen oikeudenmukaisesta jakautumisesta eri sukupolvien välillä säädettyä 1 luvun 3 §:n 2 momenttia;

hallintojärjestelmästä, keskeisistä toiminnoista, riskienarvioinnista ja riskienhallintajärjestelmästä, toimintaperiaatteista, sisäisen valvonnan järjestelmästä, varautumissuunnitelmasta, toiminnan ulkoistamisesta ja palkka- ja palkkiopolitiikasta 3 luvun 5–17 §:ssä säädettyä;

omaisuudenhoidosta ja säilytysyhteisön käyttämisestä 6 luvun 29–32 §:ssä säädettyä;

vastuuvelasta, sen kattamisesta, sijoittamisesta sekä vakavaraisuuspääomasta 5 luvun 1, 5, 10 ja 18 §:ssä sekä 6 luvun 3, 5, 7–10, 16 ja 18 §:ssä säädettyä;

tietojen toimittamisesta vakuutetuille ja etuudensaajille 7 luvussa säädettyä;

rajat ylittävästä toiminnasta 13 luvussa säädettyä tai rajat ylittävistä siirroista 14 luvussa säädettyä.
...
ottaa lisäeläkekassaan uusia vakuutettuja 12 luvun 11 §:n 2 momentin tai mainitun luvun 18 §:n 2 momentin vastaisesti,
...
toimii muutoin kuin asiamiehenä toisen välikätenä eläkesäätiö- ja eläkekassalain 3 luvun 16 §:ssä tarkoitetun äänioikeuden rajoittamista koskevan määräyksen kiertämiseksi,

käyttää lisäeläkelaitoksen varoja 6 luvun 1 §:n vastaisesti,

jakaa lisäeläkelaitoksen varoja laitoksen osakkaille 5 luvun 15 §:ssä säädetyn vastaisesti taikka

luovuttaa tai panttaa lisäeläkelaitoksen hallinnassa olevaa omaisuutta Finanssivalvonnan eläkesäätiö- ja eläkekassalain 9 luvun 2 §:n nojalla määräämän kiellon vastaisesti,
...
rikkoo eläkesäätiö- ja eläkekassalain 3 luvun 17 §:n 3 momentissa tarkoitettua velvollisuutta pitää kassankokouksen pöytäkirja nähtävillä,

rikkoo 4 luvun 1–4 §:ää tai eläkesäätiö- ja eläkekassalain 6 luvun 1, 2, 4, 5, 7 ja 8 §:ää kirjanpidon, tilinpäätöksen tai toimintakertomuksen laatimisesta tai mainitun luvun 13 §:ää tilinpäätöksen, toimintakertomuksen, tilintarkastajien lausunnon ja tilastokertomuksen toimittamisesta Finanssivalvonnalle,

jättää toimittamatta Finanssivalvonnalle 5 luvun 8 §:ssä tarkoitetut laskuperusteet etuusperusteisen lisäeläkejärjestelyn vakuutusmaksun määräytymiselle,

jättää ilmoittamatta Finanssivalvonnalle 5 luvun 25 §:ssä tarkoitetun tervehdyttämissuunnitelman tai lyhyen aikavälin rahoitussuunnitelman tai mainitun luvun 28 §:ssä tarkoitetun vastuullisen matemaatikon nimittämisestä tai eroamisesta,

jättää toimittamatta Finanssivalvonnalle 6 luvun 4 §:ssä tarkoitetun lisäeläkelaitoksen sijoitussuunnitelman,

jättää toimittamatta Finanssivalvonnalle lisäeläkelaitoksen eläkesäätiö- ja eläkekassalain 10 luvun 16 §:ssä tarkoitetun lopputilityksen sulautumisesta, mainitun lain 11 luvun 17 §:ssä tarkoitetun lopputilityksen jakautumisesta tai mainitun lain 13 luvun 33 §:ssä tarkoitetun lopputilityksen selvitysmenettelystä,

jättää toimittamatta Finanssivalvonnalle 12 luvun 4 §:ssä tarkoitetun tiedon kutsusta selvitystilaan asettamisesta päättävään kassankokoukseen, mainitun luvun 5 §:ssä tarkoitetun ilmoituksen selvitystilaan asettamisesta ja selvitysmiehen valinnasta, eläkesäätiö- ja eläkekassalain 13 luvun 27 §:ssä tarkoitetun toimintasuunnitelman hyväksyttäväksi, mainitun luvun 36 §:ssä tarkoitetun ilmoituksen lisäeläkekassan purkamisesta tai 12 luvun 15 §:ssä tarkoitetun ilmoituksen selvitystilan lopettamisesta taikka

jättää toimittamatta Finanssivalvonnalle eläkesäätiö- ja eläkekassalain 2 luvun 6 §:ssä tarkoitetun ilmoituksen osakasluettelon muutoksesta tai mainitun lain 9 luvun 5 §:ssä tarkoitetun ilmoituksen rekisteriin merkityn tiedon muuttumisesta,
