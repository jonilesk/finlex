...
sitä liikenneväylistä erillään olevassa paikassa käytetään olennaisesti muuhun tarkoitukseen kuin henkilöiden tai tavaran kuljettamiseen;

se on säilytettävänä, korjattavana, huollettavana tai pestävänä liikenneväylistä erillään olevassa paikassa;

sitä käytetään liikenteestä eristetyllä alueella kilpailu- tai testaustarkoituksiin taikka kilpailuun välittömästi liittyvään harjoitteluun.
...
direktiivillä moottoriajoneuvojen käyttöön liittyvän vastuun varalta otettavasta vakuutuksesta ja vakuuttamisvelvollisuuden voimaansaattamisesta annettua Euroopan parlamentin ja neuvoston direktiiviä 2009/103/EY;

vakuutusyhtiöllä vakuutusyhtiötä tai muuta vakuutusyritystä, joka on saanut toimiluvan harjoittaa direktiivissä tarkoitettua vakuutustoimintaa;
...
kansallisella toimistolla erityisjärjestöä, joka on perustettu 25 päivänä tammikuuta 1949 annetun Yhdistyneiden Kansakuntien Euroopan talouskomission sisämaan liikennekomitean tieliikenteen alakomitean suosituksen N:o 5 mukaisesti ja joka toimii niiden vakuutusyritysten yhteiselimenä, joilla on valtiossa toimilupa liikennevakuutusta käsittävän vakuutusliikkeen harjoittamiseen;

vihreä kortti -järjestelmällä vakuutuksenantajien kansallisten toimistojen hallinnoimaa kansainvälistä vakuutusjärjestelmää;

vihreällä kortilla kansainvälistä vakuutustodistusta, jonka vakuutusyhtiö antaa 14 kohdassa tarkoitetun suosituksen mukaisesti;

korvauselimellä direktiivin 10 artiklassa tarkoitettua korvauksen suorittamisesta vastuussa olevaa elintä;

siirtoliikennevakuutuksella ajoneuvolain (1090/2002) 66 f §:ssä tarkoitettua siirtolupaa varten annettua määräaikaista liikennevakuutusta;

liikenneväylällä yleistä ja yksityistä tietä, katua, rakennuskaavatietä, moottorikelkkailureittiä, toria sekä muuta yleiselle liikenteelle tarkoitettua tai yleisesti liikenteeseen käytettyä aluetta.
...
Liikennevakuutuskeskuksesta ja sen toiminnan rahoituksesta ja hallinnosta säädetään Liikennevakuutuskeskuksesta annetussa laissa (461/2016).
...
sellaiselle yksinomaan lapsen kuljetettavaksi tarkoitetulle ajoneuvolle, jota ei tarvitse rekisteröidä;
...
ajoneuvolle, jota ei tarvitse rekisteröidä, eikä ajoneuvoa käytetä liikenteessä;
...
### 9 § Tietojen antaminen Liikenteen turvallisuusvirastolle

Vakuutusyhtiö on velvollinen antamaan Liikenteen turvallisuusvirastolle rekisteriin merkitsemistä varten tiedon:

yhtiössä vakuutetulle ajoneuvolle otetusta uudesta vakuutuksesta seitsemän päivän kuluessa uuden vakuutuksen alkamisesta;

ajoneuvolle otetun vakuutuksen vakuutusmaksun laiminlyönnistä;

liikennekäytöstä poistetun ajoneuvon vakuutuksen irtisanomisesta.
...
ajoneuvon hallinta palautuu omistajalle tai hallinta siirtyy uudelle haltijalle, jos ajoneuvon haltija on yksin ollut vakuutuksenottaja;
...
omistajan, haltijan, kuljettajan tai matkustajan tuottamuksesta;

liikennesääntöjen vastaisesta kulusta tai sijainnista; tai
...
Sairaanhoidon kustannusten korvaamisesta säädetään lisäksi tämän lain 4 luvussa ja kuntoutuksen korvaamisesta liikennevakuutuslain perusteella korvattavasta kuntoutuksesta annetussa laissa (626/1991).
...
Jos ajoneuvon omistajalla, haltijalla tai kuljettajalla on oikeus saada omistamansa tai kuljettamansa ajoneuvon liikenteeseen käyttämisestä aiheutuneesta henkilövahingosta korvausta työtapaturma- ja ammattitautilain (459/2015), maatalousyrittäjän työtapaturma- ja ammattitautilain (873/2015) tai urheilijan tapaturma- ja eläketurvasta annetun lain (276/2009) nojalla, korvataan mainitun ajoneuvon liikennevakuutuksesta vain se osa vahingosta, jota ei korvata edellä mainittujen lakien mukaan.
...
ajoneuvon ollessa liikkumattomana ajoneuvon omistajalle, kuljettajalle tai muulle henkilölle, joka suorittaa tässä tarkoitettua työtä; eikä
...
### 55 § Kunnan tai kuntayhtymän oikeus täyskustannusmaksuun
...
Vakuutusyhtiön on annettava täyskustannusmaksusta päätös kunnalle tai kuntayhtymälle, jos kysymys on korvaukseen oikeuttavan hoidon perusteella maksettavan täyskustannusmaksun suuruudesta ja vakuutusyhtiö maksaa maksun kunnan tai kuntayhtymän laskussa tai vaatimuksessa esitettyä maksua pienempänä taikka maksu on evätty sillä perusteella, ettei kunta tai kuntayhtymä ole täyttänyt sille 56 §:ssä säädettyä ilmoittamisvelvollisuutta. Päätös annetaan myös, jos kunta tai kuntayhtymä pyytää vakuutusyhtiöltä päätöstä.
...
### 65 § Oikeus pyytää lausuntoa liikennevahinkolautakunnalta
...
jatkuvan korvauksen korottamista tai alentamista vahingonkorvauslain 5 luvun 8 §:n perusteella;
...
vakuutusyhtiölle tai sen korvausedustajalle;

sen ETA-valtion korvauselimelle, jossa vakuutusyhtiön kotipaikka sijaitsee; ja

vahingon aiheuttajalle, jos tämä on Liikennevakuutuskeskuksen tiedossa.
...
ajoneuvoa ei ole velvollisuutta vakuuttaa, sen ETA-valtion kansalliselta takuurahastolta, jossa ajoneuvolla on pysyvä kotipaikka;

vakuutusyhtiötä ei saada selville, sen ETA-valtion kansalliselta takuurahastolta, jossa vahingon aiheuttaneella ajoneuvolla on pysyvä kotipaikka;

ajoneuvo jää tunnistamatta, sen ETA-valtion kansalliselta takuurahastolta, jossa vahinko tapahtui;

kyse on ajoneuvosta, jonka pysyvä kotipaikka on kolmannessa maassa, sen ETA-valtion kansalliselta takuurahastolta, jossa vahinko tapahtui; tai

kyse on ajoneuvosta, jonka vakuuttamisvelvollisuus on laiminlyöty, sen ETA-valtion kansalliselta takuurahastolta, jossa ajoneuvolla on pysyvä kotipaikka.
...
Liikennevakuutuskeskuksen vastuulla olevista vahingoista aiheutuvat kustannukset ilman 2–6 kohdassa tarkoitettuja korvauksia, josta määrästä on vähennetty sekä 27 ja 28 §:n mukaiset maksut että raja- ja siirtoliikennevakuutuksien maksut;

35 §:ssä tarkoitetut jatkuviin korvauksiin liittyvät indeksitarkistukset;

34, 53, 54, 58 ja 59 §:ssä säädetyt sairaanhoidon korvaukset, jotka maksetaan, kun vahinkotapahtuman sattumispäivää seuraavan kalenterivuoden alusta on kulunut yli yhdeksän vuotta;

sellaiset liikennevakuutuslain perusteella korvattavasta kuntoutuksesta annetun lain 7 §:ssä tarkoitetun kuntoutuksen korvaukset, jotka maksetaan, kun vahinkotapahtuman sattumispäivää seuraavan kalenterivuoden alusta on kulunut yli yhdeksän vuotta;

55 §:n mukainen täyskustannusmaksu, kun vahinkotapahtuman sattumispäivää seuraavan kalenterivuoden alusta on kulunut yli yhdeksän vuotta;
...
### 81 § Kunnan ja kuntayhtymän muutoksenhakuoikeus
...
työnantajalta tiedot työntekijän työstä, työnantajan hänelle maksamista vastikkeista ja niiden perusteista sekä muista näihin verrattavista seikoista; ja
...
liikennekäytöstä poistetuista ajoneuvoista, joita on käytetty liikenteessä;

ajoneuvoista, joiden teknisiä ominaisuuksia on muutettu siten, että ajoneuvon luokka on muuttunut; ja

ajoneuvoista, jotka on rekisteröity yksityiskäyttöön, mutta niitä on käytetty luvanvaraisessa ammattiliikenteessä.
...
vakuutuksen voimassaoloa ja henkilövahinkoa koskevat asiakirjat vähintään 100 vuoden ajan;

muutoksenhakua koskevat asiakirjat vähintään 50 vuoden ajan, jollei niitä 1 kohdan mukaan ole säilytettävä sitä pidemmän ajan;

muut tämän lain toimeenpanoa koskevat asiakirjat vähintään 10 vuoden ajan.
...
Suomessa rekisteröityjen ajoneuvojen rekisteritunnukset;

vakuutussopimusten numerot ja päättyneiden sopimusten päättymispäivämäärät;

liikennevakuutusta Suomessa harjoittavat vakuutusyhtiöt ja niiden nimeämät korvausedustajat;

vakuuttamisvelvollisuudesta 8 §:n 1 momentin 2 kohdan nojalla vapautetut ajoneuvot sekä näiden aiheuttamista vahingoista vastuussa olevat elimet; ja

muissa ETA-valtioissa kuin Suomessa toimivien vakuutusyhtiöiden Suomeen nimeämät korvausedustajat.
...
tehdä liikennevakuutuksen toimeenpanoon liittyviä kansainvälisiä sopimuksia;

valtuuttaa edustajan huolehtimaan keskuksen tekemään vihreä kortti -sopimukseen perustuvista korvausedustajan tehtävistä;

antaa raja- ja siirtoliikennevakuutuksia;

hoitaa muita tehtäviä, jotka edistävät liikennevakuutuslainsäädännön toimeenpanoa ja kehittämistä tai liikenneturvallisuutta; ja

hoitaa hallituksensa määrittelemät palvelutehtävät.
...
### 90 § Liikenteen turvallisuusviraston ilmoitusvelvollisuus
...
ajoneuvon lopullinen poisto rekisteristä;

ajoneuvon vakuutuksen siirtyminen toiseen vakuutusyhtiöön;

ajoneuvon omistajan ja haltijan vaihtuminen; ja

ajoneuvon liikennekäyttöön ottaminen ja liikennekäytöstä poisto.
...
eräiden liikennevahingonkorvausten sitomisesta palkkatasoon annettu laki (875/1971); ja

maahan tilapäistä käyttöä varten tuotujen moottoriajoneuvojen liikennevakuutukseen liittyvistä tullilaitoksen tehtävistä annettu asetus (456/1995).
