...
turvaväriä tai kilpiä merkitsemään paikkoja, joissa on este tai pudotus;

valomerkkejä, äänimerkkejä tai ääniviestiä;

käsimerkkejä tai ääniviestiä.

Yhdessä voidaan käyttää seuraavia turvamerkkejä:

valomerkkejä ja äänimerkkejä;

valomerkkejä ja ääniviestiä;

käsimerkkejä ja ääniviestiä.
...
merkkejä ei saa asettaa liian lähekkäin;

kahta valomerkkiä, jotka voidaan sekoittaa toisiinsa, ei tule käyttää samanaikaisesti;

valomerkkiä ei tule käyttää toisen samanlaisen valolähteen läheisyydessä;

kahta äänimerkkiä ei tule käyttää samanaikaisesti;

äänimerkkiä ei tule käyttää, jos se ei erotu taustamelusta;

merkkiä ei saa sijoittaa siten, että merkin näkyvyys ja kuuluvuus vaarantuu.
...
Neuvoston direktiivi 92/58/ETY, EYVL L 245, 26.8.1992, s. 23–42

Euroopan parlamentin ja neuvosotn direktiivi 2014/27/EU, EUVL L 65, 5.3.2014, s. 1–7
