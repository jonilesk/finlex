...
date_issued: 2002-04-17
date_published: 2002-04-25
language: fin
...
virkistymis-, kuntoutus- tai hierontalaitoksessa; tai

muussa vastaavassa laitoksessa.
...
lämminvesialtaalla allasta, jonka veden lämpötila on yli 32 o C;

ulkoaltaalla allasta, joka ei ole katettu;

kävijämäärältään vähäisellä altaalla allasta, jossa käy vuorokaudessa tai veden täydellisen vaihtumisen välillä alle 60 henkilöä, ja jonka allaskuormitus on alle 0,3 henkilöä kuutiomeriä kohden vuorokaudessa;

allasryhmällä sellaisten altaiden ryhmää, joiden vedenkäsittely on yhteinen siten, että käsittelyssä altaiden vedet sekoittuvat keskimäärin vähintään kerran vuorokaudessa;

allasvedellä altaassa olevaa vettä;

poistovedellä vettä, joka johdetaan altaasta käsittelyyn;

paluuvedellä käsittelyn jälkeen altaaseen johdettavaa vettä;

korvausvedellä allasjärjestelmään johdettavaa, allasjärjestelmästä poistunutta vettä korvaavaa vettä; sekä

allaskuormituksella altaassa vuorokauden aikana käyvien henkilöiden lukumäärää jaettuna altaan vesitilavuudella (m 3 ).
