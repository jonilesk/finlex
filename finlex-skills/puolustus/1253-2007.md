...
date_issued: 2007-12-14
date_published: 2007-12-21
language: fin
skill: puolustus
issued_under: ["551/2007"]
---
...
Puolustusministeriön päätöksen mukaisesti säädetään puolustusvoimista 11 päivänä toukokuuta 2007 annetun lain (551/2007) 15 §:n 6 ja 7 momentin, 18 §:n ja 43 §:n nojalla:
...
kuvaton vieraskortti; tai

tilapäinen vierailulupa.
...
hakijan täydellinen nimi, henkilötunnus tai syntymäaika, sukupuoli, äidinkieli, kansalaisuus, kansallisuus, kansalaisuudettomuus, kotivaltio, syntymävaltio, syntymäkotikunta, kotikunta, ammatti sekä osoite ja puhelinnumero tai muu yhteystieto;

yrityksen, yhdistyksen tai muun yhteisön nimi ja yhteyshenkilö sekä puhelinnumero ja osoite;

perusteltu syy lupatodistuksen tai vierailijakortin tarpeeseen;

alue, toimipiste tai vastaava, jolle lupaa haetaan; sekä

tarpeen alkamisajankohta ja mahdollinen jo tiedossa oleva päättymisajankohta.
...
hakijan täydellinen nimi, henkilötunnus tai syntymäaika, kansalaisuus, osoite ja puhelinnumero tai muu yhteystieto;

yrityksen, yhdistyksen tai muun yhteisön nimi; sekä

vierailun syy ja kesto.
...
tuntee tehtäviä koskevat keskeiset oikeussäännöt;

hallitsee tehtävän edellyttämät käytännön toimenpiteet;

tuntee voimakeinojen käyttöä, hätävarjelua, pakkotilaa ja muita voimankäytön valtuuksia koskevat periaatteet;

on tehtävän edellyttämässä laajuudessa perehtynyt työturvallisuutta koskeviin säännöksiin; sekä

hallitsee hallussaan olevien voimankäyttövälineiden käytön.
