...
rikoslain (39/1889) 45 luvussa;

puolustusvoimista annetussa laissa (551/2007);

asevelvollisuuslaissa (1438/2007);

naisten vapaaehtoisesta asepalveluksesta annetussa laissa (285/2022);

vapaaehtoisesta maanpuolustuksesta annetussa laissa (556/2007);

sotilaallisesta kriisinhallinnasta annetussa laissa (211/2006); sekä
...
rikostorjunnalla rikoksen estämistä, paljastamista ja selvittämistä;

rikoksen estämisellä toimenpiteitä, joiden tavoitteena on estää rikos, sen yritys tai valmistelu, kun henkilön toiminnasta tehtyjen havaintojen tai siitä muuten saatujen tietojen vuoksi voidaan perustellusti olettaa hänen syyllistyvän rikokseen, taikka keskeyttää jo aloitetun rikoksen tekeminen tai rajoittaa siitä välittömästi aiheutuvaa vahinkoa tai vaaraa;

rikoksen paljastamisella toimenpiteitä, joiden tavoitteena on selvittää, onko esitutkinnan aloittamiselle esitutkintalain 3 luvun 3 §:n 1 momentissa tarkoitettua perustetta, kun henkilön toiminnasta tehtyjen havaintojen tai siitä muuten saatujen tietojen vuoksi voidaan olettaa, että rikos on tehty;

rikoksen selvittämisellä rikoksen esitutkintaa;

sotilaskurinpitomenettelyllä rikosprosessia, joka käsittää sotilasrikoksen esitutkinnan ja erityisen kurinpitomenettelyn, jossa teosta voidaan määrätä kurinpitorangaistus siten kuin tässä laissa säädetään;

sotilasrikoksilla sotilasoikeudenkäyntilain 2 §:ssä tarkoitettuja sotilasoikeudenkäyntiasioina käsiteltäviä rikoksia;

Pääesikunnan rikostorjuntatehtäviä hoitavalla viranomaisella viranomaista, joka estää, paljastaa ja selvittää sotilasrikoksia sekä estää ja paljastaa sotilaallisen maanpuolustuksen alalla Suomeen kohdistuvaan tiedustelutoimintaan ja sotilaallisen maanpuolustuksen tarkoitusta vaarantavaan toimintaan liittyviä rikoksia.
...
on selvää, ettei asianomistajalla ole vaatimuksia; ja

esitutkinnan jatkaminen asian selvitettyyn tilaan nähden on kokonaisuutena arvioiden tarpeetonta.
...
esitutkinta on toimitettu 13 §:n 2 momentissa tarkoitetulla tavalla eikä asiassa ole ilmennyt uusia seikkoja tai uutta selvitystä, josta epäiltyä olisi kuultava; tai

kurinpitopäätös on vapauttava.
...
ammattisotilaana palveleva kiinniotettavan esimies;

vartio-, päivystys- tai sotilaspoliisitehtävää suorittava sotilas;

sotilaalliseen turvaamis- tai järjestystehtävään määrätyn sotilasosaston päällikkö; sekä

22 §:ssä tarkoitettu pidättämiseen oikeutettu virkamies.

### 22 § Pidättämiseen oikeutettu virkamies

Pidättämiseen oikeutettuja virkamiehiä ovat:

asianomaisen joukkoyksikön komentaja ja häntä ylempi kurinpitoesimies;

varuskunnan päällikkö ja komendantti;

sotilaspoliisitehtävissä toimiva virassa oleva upseeri.

Sota-aluksen päällikkö voi päättää pidättämisestä, jos:

1 momentissa tarkoitettua pidättämiseen oikeutettua virkamiestä ei voida tavoittaa viestiyhteyksien toimimattomuuden tai muun vastaavan syyn vuoksi;

asia ei siedä viivytystä; ja

pidättäminen on tarpeen aluksen yleisen järjestyksen tai turvallisuuden ylläpitämiseksi taikka vakavan henkilö- tai omaisuusvahingon estämiseksi.
...
poliisista, koskee sotilasviranomaisen säilyttämien henkilöiden osalta sotilasviranomaista;

poliisimiehestä tai vartijasta, koskee tämän lain 21 §:ssä tarkoitettua kiinniottamiseen oikeutettua henkilöä ja 94 §:n 1 momentin 2 kohdassa tarkoitettua virkamiestä;

säilytystilan esimiehestä, koskee päävartion tai muun valvotun tilan esimieheksi määrättyä virkamiestä; sekä

oikaisuvaatimuksen ratkaisijasta, koskee asianomaista joukko-osaston komentajaa.
...
rikoksen tehnyt ei enää ole rikoslain 45 luvun alainen;

asianomistaja ei ole suostunut asian käsittelyyn kurinpitomenettelyssä vaan vaatii asian käsiteltäväksi tuomioistuimessa;

useista rikoksista jostakin on nostettava syyte tuomioistuimessa ja rikoksilla on yhteyttä keskenään; tai

samaan rikokseen osallisista jotakuta on syytettävä tuomioistuimessa eikä asian ratkaisemista erillisenä ole pidettävä tarkoituksenmukaisena.
...
rikoksia on ollut useita;

teko on tehty koolla olevien sotilaiden läsnä ollessa niin, että sillä voi olla kuria ja järjestystä vaarantava vaikutus; tai

rikoksentekijä on tekoa tehdessään käyttänyt väärin esimiesasemaansa.
...
asian ratkaissut kurinpitoesimies ja päätöksen tekemispäivä;
...
lopputulos sekä tarvittaessa kurinpitorangaistuksen laji ja määrä ja kurinpitorangaistuksesta mahdollisesti tehtävä vähennys.
...
kurinpitopäätös, johon muutosta haetaan;

miltä kohdin päätökseen haetaan muutosta;

mitä muutoksia päätökseen vaaditaan tehtäviksi;

perusteet, joilla muutosta vaaditaan, ja miltä osin päätöksen perustelut ratkaisupyynnön tekijän mielestä ovat virheelliset.
...
perusteet, joilla muutosta vaaditaan, ja miltä osin päätöksen perustelut valittajan mielestä ovat virheelliset;

todisteet, joihin halutaan nojautua, ja mitä kullakin todisteella halutaan näyttää toteen;

mahdollinen pyyntö asian käsittelemisestä kirjallisessa menettelyssä.
...
ylimääräistä palvelusta enintään 15 kertaa;

poistumiskieltoa enintään 40 päivää;

kurinpitosakkoa enintään 60 päivältä.
...
rikos, joka käsitellään sotilasoikeudenkäyntiasiana tai sotilaskurinpitomenettelyssä;

rikoslain 40 luvussa rangaistavaksi säädetty rikos, jos rikoksesta epäilty on tekohetkellä Puolustusvoimien palveluksessa oleva sotilas;

rikoslain 40 luvussa rangaistavaksi säädetty rikos, jos rikoksesta epäilty on tekohetkellä Puolustusvoimien palveluksessa oleva muu henkilö kuin sotilas edellyttäen, että rikoksesta voidaan todennäköisin syin epäillä myös sotilasta;

Puolustusvoimien hallinnassa olevalla alueella, aluksessa, ilma-aluksessa tai kulkuneuvossa taikka palvelustehtävässä tehty, Puolustusvoimien omaisuuteen kohdistuva sotilasoikeudenkäyntilain 2 §:n 2 momentissa tarkoitettu rikos, jos rikoksesta epäilty on tekohetkellä Puolustusvoimien palveluksessa oleva muu henkilö kuin sotilas edellyttäen, että rikoksesta voidaan todennäköisin syin epäillä myös sotilasta.
...
tekninen kuuntelu, lukuun ottamatta asuntokuuntelua;
...
päällystöön kuuluvalle poliisimiehelle ja pidättämiseen oikeutetulle virkamiehelle säädettyjä toimivaltuuksia käyttävät sotilaslakimies tai muu tutkinnanjohtajan tehtävään määrätty virkamies;

poliisimiehelle ja tutkijalle säädettyjä toimivaltuuksia käyttävät ylietsivä ja sotilasrikosten rikostorjuntatehtävään määrätty puolustusvoimista annetussa laissa tarkoitettu ammattisotilas tai muu tehtävään määrätty virkamies.
...
1 momentissa tarkoitetut tiedonhankintakeinot;
...
sotaan yllyttämiseen;

maanpetokseen tai törkeään maanpetokseen;

vakoiluun tai törkeään vakoiluun;

turvallisuussalaisuuden paljastamiseen;

luvattomaan tiedustelutoimintaan; taikka

törkeään tietoliikenteen häirintään.
...
toimenpiteen perusteena oleva rikos ja sen oletettu tekoaika;

henkilö, jonka voidaan perustellusti olettaa syyllistyvän 1 kohdassa tarkoitettuun rikokseen tai henkilön ollessa tuntematon toimenpiteen kohteena oleva teleosoite tai telepäätelaite;

tosiseikat, joihin henkilöön kohdistuva epäily ja telekuuntelun tai telekuuntelun sijasta toimitettavan tietojen hankkimisen edellytykset perustuvat;

luvan voimassaoloaika kellonajan tarkkuudella;

telekuuntelun tai telekuuntelun sijasta toimitettavan tietojen hankkimisen suorittamista johtava ja valvova 1 momentissa tarkoitettu virkamies;
...
rikokseen, josta säädetty ankarin rangaistus on vähintään neljä vuotta vankeutta;

teleosoitetta tai telepäätelaitetta käyttäen tehtyyn rikokseen, josta säädetty ankarin rangaistus on vähintään kaksi vuotta vankeutta;
...
rikokseen, josta säädetty ankarin rangaistus on vähintään kaksi vuotta vankeutta;

rikokseen, jonka johdosta teleosoite tai telepäätelaite on oikeudettomasti toisen hallussa;

muuhun kuin 1 tai 2 kohdassa tarkoitettuun teleosoitetta tai telepäätelaitetta käyttäen tehtävään rikokseen.
...
tosiseikat, joihin henkilöön kohdistuva epäily ja televalvonnan edellytykset perustuvat;

suostumus, jos se on televalvonnan käytön edellytys;

luvan voimassaoloaika kellonajan tarkkuudella;

televalvonnan suorittamista johtava ja valvova 120 §:n 1 momentissa tarkoitettu virkamies;

mahdolliset televalvonnan rajoitukset ja ehdot.
...
tosiseikat, joihin tukiasematietojen hankkimisen edellytykset perustuvat;

ajanjakso, jota lupa koskee;

tukiasema, jota lupa koskee;

tukiasematietojen hankkimisen suorittamista johtava ja valvova 120 §:n 1 momentissa tarkoitettu virkamies;

mahdolliset tukiasematietojen hankkimisen rajoitukset ja ehdot.
...
toimenpiteen perusteena oleva rikos ja sen tekoaika;

henkilö, jonka voidaan perustellusti olettaa syyllistyvän 1 kohdassa tarkoitettuun rikokseen;

tosiseikat, joihin henkilöön kohdistuva epäily ja suunnitelmallinen tarkkailu perustuvat;

luvan voimassaoloaika;

suunnitelmallisen tarkkailun suorittamista johtava ja valvova 120 §:n 1 momentissa tarkoitettu virkamies;

mahdolliset suunnitelmallisen tarkkailun rajoitukset ja ehdot.
...
suunnitelmalliseen, järjestäytyneeseen, ammattimaiseen, jatkuvaan tai toistuvaan rikolliseen toimintaan liittyvään varkauteen tai kätkemisrikokseen.
...
toimenpide ja sen tavoite riittävästi yksilöityinä;

peitellyn tiedonhankinnan toteuttava yksikkö ja siitä vastaava virkamies;

toimenpiteen perusteena oleva rikos;

peitellyn tiedonhankinnan kohteena oleva henkilö;

tosiseikat, joihin henkilöön kohdistuva epäily perustuu;

toimenpiteen suunniteltu toteuttamisajankohta;

mahdolliset peitellyn tiedonhankinnan rajoitukset ja ehdot.
...
tosiseikat, joihin henkilöön kohdistuva epäily ja teknisen kuuntelun edellytykset perustuvat;

luvan voimassaoloaika kellonajan tarkkuudella;

tila tai muu paikka, johon kuuntelu kohdistuu;

teknisen kuuntelun suorittamista johtava ja valvova 120 §:n 1 momentissa tarkoitettu virkamies;

mahdolliset teknisen kuuntelun rajoitukset ja ehdot.
...
tosiseikat, joihin henkilöön kohdistuva epäily ja teknisen katselun edellytykset perustuvat;

luvan voimassaoloaika kellonajan tarkkuudella;

tila tai muu paikka, johon katselu kohdistuu;

teknisen katselun suorittamista johtava ja valvova 120 §:n 1 momentissa tarkoitettu virkamies;

mahdolliset teknisen katselun rajoitukset ja ehdot.
...
tosiseikat, joihin henkilöön kohdistuva epäily ja teknisen seurannan edellytykset perustuvat;

luvan voimassaoloaika kellonajan tarkkuudella;

toimenpiteen kohteena oleva esine, aine tai omaisuus;

teknisen seurannan suorittamista johtava ja valvova 120 §:n 1 momentissa tarkoitettu virkamies;

mahdolliset teknisen seurannan rajoitukset ja ehdot.
...
tosiseikat, joihin henkilöön kohdistuva epäily ja teknisen laitetarkkailun edellytykset perustuvat;

luvan voimassaoloaika kellonajan tarkkuudella;

toimenpiteen kohteena oleva tekninen laite tai ohjelmisto;

teknisen laitetarkkailun suorittamista johtava ja valvova 120 §:n 1 momentissa tarkoitettu virkamies;

mahdolliset teknisen laitetarkkailun rajoitukset ja ehdot.
...
joukkotuhonta, joukkotuhonnan valmistelu, rikos ihmisyyttä vastaan, törkeä rikos ihmisyyttä vastaan, hyökkäysrikos, hyökkäysrikoksen valmistelu, sotarikos, törkeä sotarikos, kidutus, kemiallisen aseen kiellon rikkominen, biologisen aseen kiellon rikkominen tai jalkaväkimiinakiellon rikkominen;

Suomen itsemääräämisoikeuden vaarantaminen, sotaan yllyttäminen, maanpetos, törkeä maanpetos, vakoilu, törkeä vakoilu, turvallisuussalaisuuden paljastaminen tai luvaton tiedustelutoiminta;

valtiopetos, törkeä valtiopetos tai valtiopetoksen valmistelu.
...
toimenpiteen esittäjä;

tiedonhankinnan kohteena oleva henkilö riittävästi yksilöitynä;

toimenpiteen perusteena oleva rikos riittävästi yksilöitynä;

peitetoiminnan tavoite;

peitetoiminnan tarpeellisuus;

muut peitetoiminnan edellytysten arviointia varten tarvittavat tiedot.
...
peitetoiminnan toteuttava yksikkö ja peitetoiminnan toteuttamisesta vastaava Pääesikunnan 93 §:ssä tarkoitettuja rikostorjuntatehtäviä hoitava virkamies;

tunnistetiedot peitetoiminnan suorittavista Pääesikunnan 93 §:ssä tarkoitettuja rikostorjuntatehtäviä hoitavista virkamiehistä;

tiedonhankinnan perusteena oleva rikos;

peitetoiminnan kohteena oleva henkilö, jonka voidaan perustellusti olettaa syyllistyvän 4 kohdassa tarkoitettuun rikokseen;

tosiseikat, joihin epäily ja peitetoiminnan edellytykset perustuvat;

peitetoiminnan tavoite ja toteuttamissuunnitelma;
...
tiedonhankinnan toteuttava yksikkö ja sen toteuttamisesta vastaava Pääesikunnan 93 §:ssä tarkoitettuja rikostorjuntatehtäviä hoitava virkamies;

tunnistetiedot tietolähteestä;

toimenpiteen peruste;

tiedonhankinnan tavoite ja toteuttamissuunnitelma;

päätöksen voimassaoloaika;

mahdolliset tietolähteen ohjatun käytön rajoitukset ja ehdot.
...
salaisen tiedonhankintakeinon kohteen ja hänen oikeudenkäymiskaaren 17 luvun 13 §:n 1 tai 3 momentissa tarkoitetun oikeudellisen avustajansa tai 1 momentissa tarkoitetun tulkkinsa taikka mainittuun avustajaan 22 §:n 2 momentissa tarkoitetussa suhteessa olevan henkilön väliseen viestiin;

salaisen tiedonhankintakeinon kohteen ja oikeudenkäymiskaaren 17 luvun 16 §:ssä tarkoitetun papin tai muun vastaavassa asemassa olevan henkilön väliseen viestiin; eikä

rikoksen johdosta vapautensa menettäneen epäillyn ja lääkärin, sairaanhoitajan, psykologin tai sosiaalityöntekijän väliseen viestiin.
...
salaisen tiedonhankintakeinon kohteen ja hänen oikeudenkäymiskaaren 17 luvun 17 §:n 1 momentissa tarkoitetun läheisensä väliseen viestiin;

salaisen tiedonhankintakeinon kohteen ja oikeudenkäymiskaaren 17 luvun 14 §:n 1 momentissa tarkoitetun lääkärin tai muun terveydenhuollon ammattihenkilön taikka tähän 22 §:n 2 momentissa tarkoitetussa suhteessa olevan henkilön väliseen viestiin; eikä

salaisen tiedonhankintakeinon kohteen ja oikeudenkäymiskaaren 17 luvun 20 §:n 1 momentissa tarkoitetun yleisön saataville toimitetun viestin laatijan tai julkaisijan tai ohjelmatoiminnan harjoittajan taikka tähän 22 §:n 2 momentissa tarkoitetussa suhteessa olevan henkilön väliseen viestiin.
...
salaisen tiedonhankintakeinon suojaamista;
