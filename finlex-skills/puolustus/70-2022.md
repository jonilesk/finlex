...
erikoisajoneuvolla moottorikäyttöistä ajoneuvoa, joka on:

rakennettu aseeksi tai erityiseksi sotilasvälineeksi;

telavetoinen ja henkilöiden, asejärjestelmän tai tavaran kuljetukseen tarkoitettu;

sellainen raskaiden aseiden tai asejärjestelmien vetoon tai kuljetukseen tarkoitettu alustarakenteeltaan N-luokan autoa vastaava ajoneuvo, joka ylittää yhden tai useamman yleisesti tiellä sallituista mitoista tai massoista; tai

panssaroitu ja pyörillä varustettu;

panssariajoneuvolla moottorikäyttöistä ja erityisellä panssarikorilla varustettua ajoneuvoa, jonka kuljettamiseen vaaditaan aina ajaja ja johtaja ja joka on:

aseistuksella tai muulla sotilaskäyttöön tarkoitetulla välineistöllä varustettu; tai

sotilaskuljetukseen tarkoitettu;

sotilasperävaunulla erityisesti maastokäyttöön rakennettua ja tarkoitettua perävaunua sekä sitä alustarakenteeltaan vastaavaa erityisvarusteltua hinattavaa ajoneuvoa, jota ei ole tarkoitettu yksinomaan tavaran kuljetukseen;

hinattavalla sotilaslaitteella aseeksi taikka asejärjestelmän tai muun sotilaskäyttöön tarkoitetun järjestelmän osaksi rakennettua hinattavaa sotilasajoneuvoa;

maastoajoneuvolla ajoneuvolain (82/2021) 24 §:ssä maastokäyttöön tarkoitettuja ajoneuvoja;

sotilasajoneuvon erityisvalaisimella valaisinta, joka ei ole ajoneuvossa pakollinen valaisin ja jolla on erityinen sotilaallinen käyttötarkoitus;

sotilaskypärällä erityisesti sotilaskäyttöön tarkoitettua, ajoneuvoa ajettaessa ja sillä matkustettaessa käytettävää pääesikunnan hyväksymää kypärää;

pyörillä varustetulla maastoajoneuvolla avokorista neli- tai useampipyöräistä moottorikäyttöistä, jokapyörävetoista ajoneuvoa, jossa on tilaa enintään kuudelle henkilölle ja jonka kokonaismassa on enintään 2 000 kilogrammaa.
...
jarruton ajoneuvo: enintään puolet vetävän ajoneuvon omamassasta;

työntöjarruin varustettu ajoneuvo: vetävän ajoneuvon omamassan suuruinen, enintään kuitenkin 4,5 tonnia;

jatkuvatoimisella jarrujärjestelmällä varustettu keskiakseliperävaunua vastaava hinattava ajoneuvo: enintään 1,5 kertaa vetävän ajoneuvon omamassan suuruinen;

jokaisella akselilla olevin jarruin varustettu varsinaista perävaunua vastaava hinattava ajoneuvo: enintään kaksi kertaa vetävän ajoneuvon omamassan suuruinen.
...
Puolustusvoimien käytössä olevalla harjoitusalueella;

tiellä, jolla muuta liikennettä varoitetaan liikennemerkillä A33 ja lisäkilvellä, jossa on joko teksti ”PANSSARIVAUNUJA” tai ”SOTAHARJOITUS”.
