...
kulutuspalvelun turvallisuutta koskeva muu lainsäädäntö;

kulutuspalvelun turvallisuutta koskevat kansainväliset ja kansalliset standardit;

valvontaviranomaisen ohjeet ja suositukset;

kulutuspalvelun turvallisuutta koskevat käytännesäännöt;

arviointihetkellä olemassa oleva tieto ja tekniikka;

kulutuspalvelun käyttäjien ja sen välittömässä vaikutuspiirissä olevien kohtuulliset odotukset.
...
huolehdittava palvelun suunnitteluun ja toteutukseen osallistuvan henkilöstön osaamisesta, riittävästä määrästä ja selkeästä vastuunjaosta;

käytettävä kulutuspalvelun turvalliseen toteuttamiseen soveltuvia menetelmiä, tuotteita ja ympäristöä;

varauduttava erityis-, onnettomuus- ja hätätilanteisiin;
...
varmistettava kulutuspalvelun riittävä käytönaikainen valvonta; sekä

lopettaessaan kulutuspalvelun tarjoamisen poistettava siihen liittyvät vaarat.
...
kulutuspalvelun tyyppi ja luonne;

kulutuspalvelun laajuus;

kulutuspalvelun toteuttamisen olosuhteet; ja

kulutuspalvelua käyttävien ja muiden sen välittömässä vaikutuspiirissä olevien henkilöryhmien erityispiirteet.
...
poliisille siltä osin kuin se on välttämätöntä rikosten estämistä tai selvittämistä varten;

toimivaltaiselle viranomaiselle epäilemästään terveyden tai hengen suojaamiseksi säädetyn lain noudattamista koskevasta laiminlyönnistä tai epäkohdasta siltä osin kuin se on välttämätöntä epäilyn saattamiseksi kyseisen viranomaisen tietoon.
...
6 §:n 1 ja 2 momentissa säädettyä velvollisuuttaan tunnistaa kulutuspalveluun liittyvät vaarat ja arvioida niihin liittyvät riskit;

10 §:ssä säädettyä velvollisuuttaan tehdä valvontaviranomaiselle mainitussa säännöksessä tarkoitettu ilmoitus.
...
palveluntarjoajan toimet rikkomuksen korjaamiseksi;

palveluntarjoajan mahdolliset aiemmat tämän lain säännösten noudattamiseen liittyvät rikkomukset;

mahdolliset muut kuin 1–4 kohdassa tarkoitetut tapaukseen vaikuttaneet tekijät.
