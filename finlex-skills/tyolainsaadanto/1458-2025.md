...
viiden arviota edeltäneen vuoden aikana tuomittu vankeusrangaistukseen tai kolmen arviota edeltäneen vuoden aikana sakkorangaistukseen rikoksesta, jonka voidaan katsoa osoittavan hänen olevan ilmeisen sopimaton tehtävään; tai

muutoin aikaisemmalla toiminnallaan osoittanut olevansa ilmeisen sopimaton tehtävään.
...
itsenäisesti tai yhteistyössä muiden rahoitustoimijoiden kanssa myöntää ja hallinnoida luottoja, takuita, vientitakuita, takauksia ja muita vastuusitoumuksia elinkeinotoimintaan sekä tehdä takauspäätöksiä, joiden puitteissa rahoittaja tai luottovakuuttaja voi myöntää useita yksittäisiä rahoituksia;

toimia vienninrahoituslaitoksena;

osallistua Euroopan unionin rahoitusvälineisiin sekä tehdä yhteistyötä julkisen ja yksityisen sektorin toimijoiden, Euroopan unionin instituutioiden ja kansainvälisten tahojen kanssa.

Yhtiö voi tehtäviensä toteuttamiseksi:

tehdä varainhankintaa ja -hallintaa;
...
tehdä toimintaansa ja yritysrahoitukseen liittyviä tutkimuksia ja selvityksiä, harjoittaa yritysrahoituksen kehitys- ja palvelutoimintaa sekä hoitaa muita erityisrahoitustehtäviä.
...
kotimaan rahoituksen lainojen, takausten ja muiden vastuusitoumusten valtuuden osuus on enintään 10 miljardia euroa;

vientitakuiden valtuuden osuus on enintään 40 miljardia euroa; ja

takausten ja muiden vienninrahoituksen vastuusitoumusten valtuuden osuus on enintään 40 miljardia euroa; tämän kohdan ja 2 kohdan mukaiset valtuudet eivät kuitenkaan saa olla yhteensä enempää kuin 40 miljardia euroa; enintään 20 miljardia euroa edellä 1 ja 2 kohdassa sekä tässä kohdassa tarkoitetuista valtuuksista voi olla 10 ja 11 §:n mukaisissa menettelyissä päätettyä rahoitusta.
...
päättää rahaston varoista yhtiölle 17 §:n 2 momentin nojalla tehtävistä maksuista;

tehdä 17 §:n 3 momentissa tarkoitettu esitys;

päättää 17 §:n 4 momentissa tarkoitetun lainan myöntämisestä ja sen ehdoista;

päättää tämän pykälän 5 momentissa tarkoitetun hallinnointipalkkion maksamisesta yhtiölle;

antaa vuosittain kuuden kuukauden kuluessa kalenterivuoden päättymisestä työ- ja elin-keinoministeriölle kertomus toiminnastaan;

tehdä esitys rahaston talousarvioksi; ja

hyväksyä ja allekirjoittaa rahaston tilinpäätös.
...
toisilleen rahoitustoimintaa tai riskienhallintaa varten;

työ- ja elinkeinoministeriölle ja valtiovarainministeriölle niiden pyynnöstä yhtiön toiminnan ohjaamista, valvontaa ja valtiontukien maksatuksen keskeyttämistä ja takaisinperintää varten;

Finanssivalvonnalle rahoitusvalvonnan toteuttamista varten.
...
valtion erityisrahoitusyhtiön perustamiseen liittyvistä järjestelyistä annettu laki (442/1998);

valtion erityisrahoitusyhtiöstä annettu laki (443/1998);

valtiontakuurahastosta annettu laki (444/1998);

valtion erityisrahoitusyhtiön luotto-, takaus- ja pääomasijoitustoiminnasta annettu laki (445/1998);

valtion vientitakuista annettu laki (422/2001);

valtion alustakauksista annettu laki (573/1972);

valtion takuista perusraaka-ainehuollon turvaamiseksi annettu laki (651/1985);

ympäristönsuojelu- ja energiainvestointeihin myönnettävistä valtiontakauksista annettu laki (609/1973);

julkisesti tuetuista vienti- ja alusluotoista sekä korontasauksesta annettu laki (1543/2011);

Suomen Vientiluotto Oy -nimisestä yhtiöstä annettu laki (1136/1996).
