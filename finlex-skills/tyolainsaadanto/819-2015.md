...
räjähteen valmistusta ja käsittelyä käyttöpaikalla sen välitöntä käyttöä varten siltä osin, kun siitä säädetään räjäytys- ja louhintatyön turvallisuudesta annetussa valtioneuvoston asetuksessa (644/2011); eikä

yksityisen henkilön asianomaisella luvalla hallussa pidettävien ampuma-aseiden patruunoiden lataamista omaa tarvetta varten.

Tämän asetuksen säännökset räjähteiden siirrosta eivät koske:

pyroteknisiä tuotteita;

ampuma-aseissa, työkaluissa tai lähetyspistooleissa käytettäviä patruunoita tai niihin rinnastettavia välineitä; eikä

ampuma-aseen hallussapitoon oikeutetun yksityisen henkilön omaa tarvetta varten hankkimaa ruutia ja sytytysnalleja.
...
vaarallisuusluokalla räjähteiden jakoa kuuteen vaarallisuusluokkaan sen mukaan, kuinka suuren vaaran räjähde mahdollisessa onnettomuustapauksessa voi aiheuttaa ympäristölle; vaarallisuusluokan määritys tehdään vaarallisten aineiden kuljetuksesta tiellä annetun Liikenteen turvallisuusviraston määräyksessä määritellyin menetelmin;

räjähteen määrällä räjähdysaineen nettomäärää;

pyroteknisen tuotteen luokalla pyroteknisten tuotteiden vaatimustenmukaisuudesta annetussa valtioneuvoston asetuksessa (719/2015) säädettyä ilotulitteiden, teattereissa käytettävien pyroteknisten tuotteiden ja muiden pyroteknisten tuotteiden jakoa luokkiin F1, F2, F3 ja F4 sekä T1 ja T2 sekä P1 ja P2;

pelastautumisvälineellä hätätilanteita varten hankittavia valaisu- ja merkinantovälineitä sekä niihin verrattavia räjähteitä, joiden vaatimustenmukaisuutta ei osoiteta pyroteknisten tuotteiden vaatimustenmukaisuudesta annetun valtioneuvoston asetuksen mukaisesti;

valmistuksella räjähteen valmistamista raaka-aineista ja valamista sekä muuta vastaavaa muokkaamista siten, että tuotteen ominaisuudet tai olomuoto muuttuvat, sekä räjähteen komponenttien yhdistämistä, räjähteen käyttökuntoon saattamista muualla kuin käyttöpaikalla, räjähteen pakkaamista ja muuta vastaavaa toimintaa, joissa räjähteen olomuoto ei muutu.
...
paikka, jossa valmistusta saa harjoittaa;

yleiskuvaus toiminnasta;

valmistettavien räjähteiden suurin sallittu määrä ja vaarallisuusluokka;

mahdolliset toiminnan rajoitukset sekä muut turvallisuuden vuoksi asetettavat ehdot;
...
### 7 § Lupapäätöksestä tiedottaminen
...
kemikaalien suurin sallittu määrä ja vaarallisuusluokka;
...
valmistajan tai maahantuojan nimi ja yhteystiedot;

valmistuksesta tai maahantuonnista vastaavan henkilön tai henkilöiden nimet, heidän pätevyytensä ja heille annettu koulutus;

selvitys ilotulitteiden varastoinnin järjestelyistä;

selvitys laadunvalvonnan järjestelyistä;

selvitys paikasta, jossa toiminnanharjoittaja voi tehdä koeammunnat koulutusta, laadunvalvontaa tai hävittämistä varten;

selvitys menettelyistä, joilla virheellisen tuotteen vähittäismyynti keskeytetään ja tarvittaessa saadaan kerätyksi pois kuluttajilta;

selvitys menettelyistä, joilla ilmoitetaan viranomaisille ja tarvittaessa tiedotusvälineille tuotevirheestä;

selvitys menettelyistä, joilla omassa toiminnassa tai vähittäismyynnissä viallisiksi todetut ilotulitteet hävitetään;

tieto vastuuvakuutuksen suuruudesta.
...
näytöksen järjestäjän nimi ja yhteystiedot;

näytöksistä vastaavaksi henkilöksi nimettävän henkilön tai henkilöiden nimet, heidän pätevyytensä ja heille annettu koulutus;

näytöksissä käytettävien pyroteknisten ja muiden tuotteiden ammunnassa käytettävien laitteiden periaatteellinen toiminta- ja turvajärjestelmäkuvaus;

selvitys ilotulitteiden säilytyksestä ja käsittelystä ampumapaikalla;

selvitys toimenpiteistä, joilla toiminnanharjoittaja varmistuu tuotteiden ja käyttämiensä laitteiden asianmukaisuudesta;

selvitys menettelyistä turvallisuuden varmistamiseksi tuotteita ammuttaessa;
...
räjähteiden vaarallisuusluokat ja suurimmat sallitut määrät; sekä
...
minkälaisesta varastoinnista on kyse;

tiedot varastoitavista räjähteistä;

räjähteiden enimmäismäärät;

päätöksen voimassaoloaika;

toimintaa koskevat rajoitukset ja ehdot;

käyttöönottotarkastuksen menettelyt.
...
vaaraan mahdollisessa onnettomuustilanteessa joutuva alue ja mahdollinen henkilömäärä;

pelastustiet ja järjestelmät ihmishengen ja omaisuuden pelastamiseksi, palon sammuttamiseksi, avun hälyttämiseksi ja vaaran torjumiseksi;

muut lupapäätöksessä vaaditut asiat.
...
muut Turvallisuus- ja kemikaaliviraston lupaa edellyttävät tuotantolaitokset vähintään kerran viidessä vuodessa.
...
räjähteiden lähettäjän ja siirron järjestäjien nimet ja osoitteet;
...
kuljetustapa ja -reitti sekä tarvittaessa rajanylityspaikat Euroopan talousalueella; sekä
...
varastoitavien räjähteiden suurimmat sallitut määrät ja luokka;
...
kädessä pidettäviä luokan F2 ilotulitteita;

paukkupommeja yksittäisinä tai yhdistelmätuotteiden osina, lukuun ottamatta tuotteita, joissa yksittäinen pamahtava panos sisältää enintään 0,05 g mustaruutia;

paukkupommeja, jotka syttyvät iskusta maahan heittämällä;

roomalaisia kynttilöitä yksittäisinä tuotteina, joiden laukaisuputken sisähalkaisija on alle 20 millimetriä;

kertalaukeavia tähtipommeja yksittäisinä tuotteina, joiden putken sisähalkaisija on alle 28 millimetriä ja avauspanoksena muu kuin mustaruuti;

luokan F2 mukaisista raketeista miniraketteja;
...
työmaan arvioitu kestoaika ja arvioidut räjäytyspäivät tai -viikot;

räjäytystyön johtajan nimi ja yhteystiedot;

räjähteiden säilytys- ja varastopaikat työmaalla; sekä

tarvittaessa selvitys räjähteiden valmistuksesta siirrettävällä laitteistolla sekä siihen liittyvien vaarallisten kemikaalien varastoinnista.
...
miten ilotulitteet aiotaan varastoida ja säilyttää näytöspaikalla;

suojaetäisyydet ja muut varotoimenpiteet onnettomuuksien ehkäisemiseksi;

vastuuhenkilö yhteystietoineen; sekä

näytöksen ampujien henkilötiedot yhteystietoineen.
...
ajankohta ja paikka, missä erikoistehosteita käytetään;

toiminnan tarkoitus;

arvioitu tilaisuuden osallistujamäärä;

käytettävät tehosteet;

käytettävien tehosteiden toimintatapa ja suojaetäisyydet;

räjäytyssuunnitelma, jossa kirjallisesti esitetään tehtävät räjäytystyöt;

käytettävien tehosteiden varastointi- ja vartiointijärjestelyt alueella;

vastuuhenkilö yhteystietoineen ja tieto hänen pätevyydestään;

toimintaohjeet tuotteiden turvalliselle käytölle;

suunniteltu sammutuskalusto ja toimintaohjeet onnettomuuksien varalta.
...
käyttäjien henkilö- ja yhteystiedot.
...
luovutetun räjähteen vastaanottajaa koskevat tiedot;

peruste luovutuksen sallimiseksi;

varastoon tulleet ja sinne jääneet räjähteet ja määrät;

varastoon tulleiden räjähteiden toimittaja ja hänen yhteystietonsa.
...
lähetetyt räjähteet ja niiden vastaanottajien nimet sekä siirtotodistusten numerot;

varastossa olevat räjähteet; sekä
...
tiedot onnettomuudessa osallisina olleista räjähteistä, kemikaaleista ja mahdollisen päästön määrästä;
...
räjähteen määrän merkittävä kasvu tuotantolaitoksessa, vaikka suojaetäisyys ei kasvaisi;

käsiteltävien tai varastoitavien räjähteiden vaarallisuusluokan merkittävä muutos vaarallisempaan suuntaan siten, että sillä ei ole merkitystä suojaetäisyyksiin;

valmistusmenetelmän tai käsittely- tai varastointitavan merkittävä muutos;

suoja-alueella tapahtuvat muutokset; tai
...
räjähteiden valmistusta ja varastointia koskevat luvat ja muut päätökset, jotka uudelle toiminnanharjoittajalle on tarkoitus siirtää.
...
tuotteet ovat hyväksymispäätösten ja niiden ehtojen mukaisia;

tuotteet ovat ehjiä ja toimivat tarkoitetulla tavalla;

tuotteisiin kiinnitetyt merkinnät ovat kemikaaliturvallisuuslain 69 §:n ja hyväksymispäätöksen mukaiset; sekä

tuotteissa on mukana selkeä ja ymmärrettävä suomen- ja ruotsinkielinen käyttöohje.
...
Valmistus- tai maahantuontierän suuruus, Q kpl

Näytteen suuruus, kpl
...
1 päivään kesäkuuta 2017 mennessä, jos tuotantolaitokseen ei sovelleta tämän asetuksen voimaan tullessa voimassa olleita turvallisuusselvityksen tekemistä koskevia säännöksiä.
