...
sijoitusrahastolain (213/2019) 2 luvun 4 §:ssä tarkoitettua rahastoyhtiön toimilupaa;

sijoitusrahastolain 20 luvun 2 §:ssä tarkoitettua säilytysyhteisön toimilupaa; tai

sijoitusrahastolain 22 luvun 2 §:n 1 momentissa tarkoitettua lupaa rahastoyhtiölle perustaa sivuliike kolmanteen maahan.
...
jäljennös yhtiön voimassa olevasta yhtiöjärjestyksestä;

ote tai jäljennös siitä yhtiökokouksen päätöksestä mahdollisine liitteineen, jolla yhtiöjärjestys on päätetty muuttaa vastaamaan rahastoyhtiön yhtiöjärjestyksen edellytyksiä ja josta ilmenevät sekä yhtiön aikomus hakea rahastoyhtiön toimilupaa, että toimiluvan hakemisessa noudatettava menettely;

selvitys siitä, että 2 kohdassa tarkoitettu yhtiöjärjestyksen muutos on jätetty rekisteröitäväksi patentti- ja rekisterihallitukselle siten kuin siitä säädetään osakeyhtiölain (624/2006) 5 luvun 30 §:n 2 momentissa;
...
ote tai jäljennös rahastoyhtiön perustamista koskevasta päätöksestä, jos perustajana on oikeushenkilö;

kunkin perustajan kaupparekisteriote, jos perustaja on oikeushenkilö, tai kunkin perustajan virkatodistus ja yhteystiedot, jos perustaja on luonnollinen henkilö;

jäljennös perustamiskirjasta;
...
ansioluettelo, josta ilmenevät henkilön täydellinen nimi, henkilötunnus, syntymäpaikka, koulutus, asema rahastoyhtiössä ja mahdolliset aikaisemmat tehtävät finanssitoimialalla, aikaisempi työkokemus sekä osallistuminen merkittäviin koulutusohjelmiin tai ammatillisiin kursseihin;

yksityiskohtainen selvitys henkilön tehtävistä ja vastuista rahastoyhtiössä;
...
ote Oikeusrekisterikeskuksen velkajärjestelyrekisteristä;

ote Oikeusrekisterikeskuksen liiketoimintakieltorekisteristä;
...
jos toinen finanssivalvontaviranomainen on tehnyt henkilöstä sopivuus- ja luotettavuusselvityksen, tieto selvityksen tuloksesta;

tiedot henkilön jäsenyydestä tai varajäsenyydestä muun yhteisön hallituksessa tai hallintoneuvostossa taikka henkilön toimimisesta muun yhteisön johdossa;

selvitys mahdollisesta muusta sellaisesta seikasta, jota henkilö pitää olennaisena arvioitaessa hänen sopivuuttaan ja luotettavuuttaan.
...
kuvaukset rahasto-osuusrekisterin pitämisestä, rahasto-osuuksien merkintöjen ja lunastusten tekemisestä ja rahasto-osuuden arvonlaskennasta;

kannattavuusarviot ja tavoitteet sekä tulos- ja tase-ennusteet ja niiden perusteet seuraavalle kolmelle vuodelle;

arvio omien varojen riittävyydestä seuraavalle kolmelle vuodelle ja suunnitelma riittävän vakavaraisuuden varmistamiseksi ja, jos yhtiö aikoo harjoittaa sijoitusrahastolain 2 luvun 2 §:n 2 momentissa tarkoitettua toimintaa, suunnitelma maksuvalmiuden varmistamiseksi;

selvitys asiamiehen välityksellä harjoitettaviksi aiotuista sekä muista ulkoistettavista toiminnoista sisältäen asiamiesten nimet ja yhteystiedot.

Säilytysyhteisön toimintasuunnitelmassa on oltava:

yksityiskohtainen kuvaus harjoitettavaksi aiotun toiminnan laadusta ja laajuudesta;

kannattavuusarviot ja tavoitteet sekä tulos- ja tase-ennusteet ja niiden perusteet seuraavalle kolmelle vuodelle;

selvitys sijoitusrahastolain 20 luvun 9 §:n 2 momentissa tarkoitetun pääomavaatimuksen täyttymisestä;

selvitys varojen säilyttämisen ulkoistamisesta.
...
jäljennös hakemuksesta, jolla rahastoyhtiö on hakenut sijoittajien korvausrahaston jäsenyyttä;

selvitys pääoman saatavuudesta (pääomasuunnitelma), laskelmat riskialueittaisesta pääomavaatimusten täyttymisestä ja kuvaus vakavaraisuuden hallinnan järjestämisestä.

### 10 § Toiminnan järjestäminen, sisäinen valvonta ja riskienhallinta

Rahastoyhtiön toimilupahakemukseen on liitettävä:

kuvaus rahastoyhtiön organisaatiosta, tehtävien ja vastuiden jaosta sekä päätöksentekojärjestelmästä;

selvitys palkattavan henkilöstön määrästä sekä henkilöstölle asetettavista ammatillisista vaatimuksista;

kuvaus toimeksiantojen huolellisen toteuttamisen järjestämiseksi tehdyistä järjestelyistä;

kuvaus organisaatio- ja hallintojärjestelyistä eturistiriitojen tunnistamiseksi, ehkäisemiseksi ja hallitsemiseksi;

kuvaus vaikuttavassa asemassa olevan henkilön henkilökohtaisten liiketoimien toteuttamisesta;

kuvaus asiakasvalitusten käsittelystä;

kuvaus kannustimiin sovellettavista periaatteista;

säilytysyhteisösopimus tai luonnos säilytysyhteisösopimukseksi;

kuvaus sisäisen valvonnan, riskienhallinnan ja liiketoiminnasta riippumattoman riskienhallinnan arvioinnin järjestämisestä;

kuvaus järjestelmistä ja menetelmistä, joilla rahastoyhtiön on tarkoitus seurata ja hallita sijoitusrahastolain 5 luvussa tarkoitettuja riskejä;

kuvaus sisäisen tarkastuksen järjestämisestä;

kuvaus toimintojen laillisuuden ja sisäisten menettelytapojen noudattamisen valvonnan järjestämisestä;

kuvaus riittävän tiedonkulun sekä riskienhallinnan ja sisäisen valvonnan turvaamisesta asiamiehen välityksellä harjoitettavien ja muiden ulkoistettavien toimintojen osalta;

selvitys kirjanpitojärjestelmästä ja kirjanpitomenetelmistä;

kuvaus tietojärjestelmistä, tietohallintostrategiasta ja tietohallinto-organisaatiosta sekä ulkoistettavista tietotekniikkapalveluista;

kuvaus tietoturvallisuusorganisaatiosta, tietoturvallisuusvastuista ja -periaatteista sekä tietoturvallisuuteen liittyvien riskien hallinnasta;

tietoturvallisuuteen liittyvät keskeiset ohjeet;

selvitys siitä, miten rahastoyhtiö on varautunut toiminnan jatkumiseen häiriötilanteissa;

rahastoyhtiön keskeisten toimintojen jatkuvuussuunnitelmat.
...
jäljennös rahastoyhtiön toimivaltaisen hallintoelimen päätöksestä perustaa sivuliike kolmanteen maahan;

kolmannen maan asianomaisen viranomaisen lupa sivuliikkeen perustamiseen, jos tällainen lupa vaaditaan kyseisessä kolmannessa maassa;

selvitys kolmannen maan rahastoyhtiön toimintaa ja valvontaa koskevasta lainsäädännöstä;

selvitys Finanssivalvonnan valvonta- ja tietojensaantioikeuksista sivuliikkeessä;

selvitys kolmannen maan valvontaviranomaisen valvontaoikeuksista sivuliikkeessä;

sivuliikkeen osoite- ja yhteystiedot;

sivuliikkeen liiketoimintasuunnitelma;

selvitys sivuliikkeen sijoittumisesta rahastoyhtiön organisaatioon ja sivuliikkeen organisaatiorakenne;

tiedot sivuliikkeen johtoon kuuluvista henkilöistä sekä tämän luvun 6 §:ssä tarkoitettu selvitys näistä henkilöistä;

selvitys siitä, miten rahastoyhtiön sisäinen valvonta ja riskienhallinta sivuliikkeessä järjestetään;

selvitys rahastoyhtiön ja sen sivuliikkeen välisestä raportoinnista ja muusta tietojen vaihdosta sekä sen järjestämisestä.
...
rahastoyhtiössä valvontatehtävään osallistuvan henkilön palkan tai palkkion tulee määräytyä henkilön tehtäviin liittyvien tavoitteiden saavuttamisen perusteella riippumatta henkilön valvoman liiketoimintayksikön tuloksesta;
...
tuloksen arviointi on toteutettava osana rahastoyhtiön hoitaman sijoitusrahaston osuudenomistajille suositellun rahasto-osuuksien hallussapitoajan mukaista monivuotista kehystä sen varmistamiseksi, että arviointi perustuu sijoitusrahaston pidemmän aikavälin tulokseen ja sijoitusriskeihin ja että palkan ja palkkioiden tulosperusteisten osien suoritus jakautuu samalle ajanjaksolle;

palkan ja palkkioiden taattu muuttuva osa voidaan maksaa vain uuden henkilöstön palkkaamisen yhteydessä ja ainoastaan palvelussuhteen ensimmäisenä vuonna;
...
sopimuksen ennenaikaiseen päättymiseen liittyvät maksut perustuvat pitkän aikavälin tulokseen eivätkä maksamisperusteet saa johtaa epäonnistuneen suorituksen palkitsemiseen;

palkan tai palkkion muuttuvien osien laskemisessa on otettava huomioon arviointihetkellä tiedossa olevat riskit.
...
sijoitusrahaston nimi;

sijoitusrahaston sääntöjen viimeisin vahvistamispäivä ja vahvistamisvaltio, toiminnan aloittamispäivä sekä toimikausi, jos sellainen on määrätty;

tiedot siitä, missä sijoitusrahaston vuosikertomus ja puolivuotiskatsaus ovat saatavilla;

sijoitusrahaston tilinpäätösajankohta;

sijoitusrahaston tilintarkastajien sekä heidän varamiestensä nimet taikka hyväksytyn tilintarkastusyhteisön nimi;

sijoitusrahaston varojen arvostamista koskevat periaatteet ja menetelmät;

se, että rahasto-osuus oikeuttaa rahasto-osuuksien määrän suhteessa jakautuvaan osuuteen sijoitusrahaston tai sen mahdollisen alarahaston varoista ottaen huomioon rahasto-osuussarjojen ja -lajien suhteelliset arvot;

tiedot rahasto-osuudenomistajien kokouksesta sekä äänivallan käyttöoikeudesta rahasto-osuudenomistajien kokouksessa;

tiedot säännellyistä markkinapaikoista, joissa rahasto-osuudet ovat kaupankäynnin kohteena säännellyllä markkinalla;

säännöissä määrätyt osuuksien liikkeeseenlaskun ajankohdat ja tilanteet, joissa rahasto-osuuksien liikkeeseenlasku voidaan keskeyttää, sekä tilanteet, joissa rahasto-osuuksien lunastusta voidaan rajoittaa taikka se voidaan keskeyttää tai toteuttaa poikkeuksellisesti ilman rahasto-osuudenomistajan suostumusta;

rahasto-osuuksien merkintä- ja lunastushinnan määräytymismenetelmä ja -aikaväli;

se, missä ja milloin rahasto-osuuden merkintä- ja lunastushinnat julkistetaan;

sijoitusrahaston omistajaohjauksen tavoitteet ja omistajaohjauksen periaatteet, jos periaatteita ei esitetä rahastoyhtiön internetsivuilla;

sijoitusrahaston sulautumishistoria.
...
sijoitustoiminta, sen tavoitteet ja sijoituksiin erityisesti liittyvät riskit;

aiempi tuottokehitys ja siihen liittyvä varoitus, että sijoitusrahastoon tehdyn sijoituksen arvo voi nousta tai laskea ja että sijoittaja voi sijoituksensa lunastaessaan saada takaisin vähemmän kuin hän siihen alun perin sijoitti;

sijoittajakohderyhmä.

Edellä 1 momentin 1 kohdassa tarkoitetuissa tiedoissa on tuotava esiin ainakin:

se, pyritäänkö sijoitustoiminnan tavoitteisiin aktiivisen vai passiivisen omaisuudenhoidon keinoin;

pääasialliset sijoituskohteet;

korkoa tuottaviin sijoituskohteisiin sijoittavista sijoitusrahastoista korkosijoitusten keskimääräistä voimassaoloaikaa koskevat mahdolliset rajoitukset;

osakkeisiin sijoittavista sijoitusrahastoista sijoitusastetta osakemarkkinoille koskevat mahdolliset rajoitukset.
...
osuudenomistajille tarpeellinen lyhyt kuvaus sijoitusrahastoon ja osuudenomistajaan sovellettavasta verotuksesta;

rahasto-osuuden merkinnästä ja sen lunastamisesta rahasto-osuudenomistajalta veloitettavat maksut ja niiden määräytymisperuste;

toiminnasta aiheutuvat muut mahdolliset kulut tai niiden määräytymisperuste vuoden ajalta jaoteltuina sijoitusrahaston ja sen osuudenomistajan maksettaviin kuluihin;

sijoitusrahastosta rahastoyhtiölle, säilytysyhteisölle tai kolmansille osapuolille maksettavien palkkioiden ja korvausten määrä sekä niiden laskeminen ja suoritustapa vuoden ajalta;

rahasto-osuuksien liikkeeseenlasku- ja lunastusaika, -paikka ja -tapa;

rahasto-osuuksien tuotonmaksuaika, -paikka ja -tapa;

rahasto-osuuden arvon julkistamisajankohta, -paikka ja -tapa.
...
sijoitusrahastoa hoitavan rahastoyhtiön toiminimi ja sen kotivaltio;

siitä, miltä osin rahastoyhtiö käyttää toiminnassaan asiamiehiä;

rahastoyhtiön kotipaikka ja hallinnollinen päätoimipaikka, jos se ei ole sama kuin kotipaikka;

rahastoyhtiön perustamispäivä sekä sen toimintakausi, jos se on määrätty;

rahastoyhtiön toimiala;

onko rahastoyhtiöllä myös vaihtoehtorahastojen hoitajan toimilupa tai onko se rekisteröitynyt vaihtoehtorahastojen hoitaja;

tiedot muista rahastoyhtiön hoitamista sijoitusrahastoista;

tiedot sellaisen rahastoyhtiön, jolla on vaihtoehtorahastojen hoitajan toimilupa tai joka on rekisteröitynyt vaihtoehtorahastojen hoitaja, hoitamista vaihtoehtorahastoista;

rahastoyhtiön hallituksen jäsenten ja varajäsenten nimet;

rahastoyhtiön toimitusjohtajan ja toimitusjohtajan sijaisen nimi;

rahastoyhtiön osakepääoma.
...
sijoitusrahaston säilytysyhteisön toiminimi, yritys- ja yhteisötunnus tai vastaava yksilöintitieto, posti- ja käyntiosoite sekä muut säilytysyhteisön mahdollisesti ilmoittamat yhteystiedot;

säilytysyhteisön kotipaikka ja hallinnollinen päätoimipaikka, jos se ei ole sama kuin

kotipaikka;

kuvaus säilytysyhteisön tehtävistä ja mahdollisista eturistiriidoista, joita voi syntyä;

kuvaus varojen säilyttämisen ulkoistamisesta sekä luettelo kolmansista osapuolista, joille säilyttäminen on ulkoistettu, ja osapuolista, joille ensiksi mainittu kolmas osapuoli on sen edelleen siirtänyt, sekä kuvaus ulkoistamisesta ja sen edelleen siirtämisestä aiheutuvista mahdollisista eturistiriidoista;

ilmoitus siitä, että 1–4 kohdassa tarkoitetut ajan tasalla olevat tiedot asetetaan pyynnöstä sijoittajien saataville.
...
se, että syöttörahaston varoista sijoitetaan pysyvästi vähintään 85 prosenttia kohderahaston varoihin;

tiedot sijoitustavoitteesta ja -politiikasta ja niihin erityisesti liittyvistä riskeistä sekä siitä, onko syöttörahastolla ja kohderahastolla sama tulos ja missä määrin ja mistä syistä ne eroavat toisistaan sekä kuvaus sijoitusrahastolain 14 luvun 1 §:n 1 momentissa tarkoitetuista sijoituksista;

lyhyt kuvaus kohderahastosta, sen organisaatiosta, sijoitustavoitteesta ja -politiikasta sekä niihin erityisesti liittyvistä riskeistä;

tiivistelmä sijoitusrahastolain 14 luvun 4 §:n 1 momentissa tarkoitetusta syöttörahastoa hoitavan rahastoyhtiön ja kohderahastoa hoitavan rahastoyhtiön tai kohderahastona olevan yhteissijoitusyrityksen välisestä sopimuksesta tai pykälän 2 momentissa tarkoitetuista liiketoiminnan harjoittamista koskevista sisäisistä säännöistä;

tiedot siitä, miten osuudenomistajat voivat saada lisätietoja kohderahastosta tai 4 kohdassa tarkoitetusta sopimuksesta;

kuvaus palkkioista ja kulukorvauksista, jotka aiheutuvat syöttörahaston varojen sijoittamisesta kohderahastoon, sekä syöttörahaston ja kohderahaston kokonaiskuluista;

kuvaus syöttörahastolle aiheutuvista verovaikutuksista, jotka johtuvat sen varojen sijoittamisesta kohderahastoon.
...
niiden hallussapidosta voi aiheutua tappio, joka rajoittuu arvopapereista maksettuun määrään;

niiden likviditeetti ei vaaranna rahastoyhtiön velvollisuutta lunastaa hoitamansa sijoitusrahaston rahasto-osuus sijoitusrahastolain 10 luvun 5 §:n 1 momentissa ja 10 luvun 6 §:ssä tarkoitetuissa tilanteissa;

niiden arvo voidaan määritellä luotettavasti siten kuin 2 momentissa säädetään;

niistä on saatavilla asianmukaiset tiedot siten kuin 3 momentissa säädetään;

niiden hankinta vastaa sijoitusrahaston sääntöjen mukaisia tavoitteita;

niihin liittyvät riskit otetaan huomioon rahastoyhtiön riskienhallintajärjestelmässä.
...
ne täyttävät tämän luvun 1 §:ssä säädetyt vaatimukset ja ovat vaihdantakelpoisia;

niihin sovelletaan osakeyhtiöön sovellettavia hallinto- ja ohjausjärjestelmiä vastaavia järjestelmiä;

niitä hoitavaa yritystä koskee sijoittajien suojaamiseksi annettu sääntely.
...
sen erääntymisaika liikkeeseenlaskuhetkellä on enintään 397 päivää;

sen jäljellä oleva erääntymisaika on enintään 397 päivää;

sen korkotuotto oikaistaan säännöllisesti rahamarkkinoiden muutosten mukaisesti vähintään 397 päivän välein; tai

sen riskiprofiili, mukaan lukien korko- ja luottoriski, vastaa sellaisten rahoitusvälineiden riskiprofiilia, joiden erääntymisaika on 1 tai 2 kohdan mukainen, tai joiden korkotuottoja oikaistaan 3 kohdassa tarkoitetulla tavalla.
...
joiden avulla rahastoyhtiö voi laskea nettoarvon sen arvon mukaisesti, jolla rahastoyhtiön arvopaperiomistuksiin sisältyvä rahoitusväline on vaihdettavissa asiaa tuntevien, liiketoimeen halukkaiden sekä toisistaan riippumattomien osapuolten välillä; ja

jotka perustuvat joko markkinatietoihin tai arvostusmalleihin mukaan lukien jaksotettuun hankintamenoon perustuvat menetelmät.
...
niistä on saatavilla tiedot, joiden avulla voidaan arvioida rahamarkkinavälineisiin tehtyihin sijoituksiin liittyvät luottoriskit, sekä muut asianmukaiset tiedot, siten kuin 2–4 momentissa tarkemmin säädetään; ja

ne ovat vaihdantakelpoisia.
...
tiedot, jotka koskevat sekä liikkeeseenlaskua tai liikkeeseenlaskuohjelmaa että liikkeeseenlaskijan oikeudellista ja taloudellista asemaa ennen rahamarkkinavälineen liikkeeseenlaskua ja jotka ovat liikkeeseenlaskijasta riippumattoman pätevän kolmannen osapuolen varmentamia;

1 kohdassa tarkoitetuista tiedoista säännöllisesti päivitetyt tiedot ja tiedot niissä tapahtuvista merkittävistä muutoksista;

olemassa olevat luotettavat tilastot liikkeeseenlaskusta tai liikkeeseenlaskuohjelmasta.

Sijoitusrahastolain 13 luvun 4 §:n 1 momentin 3 kohdassa tarkoitetuista rahamarkkinavälineistä on oltava saatavilla:

tiedot, jotka koskevat liikkeeseenlaskua tai liikkeeseenlaskuohjelmaa tai liikkeeseenlaskijan oikeudellista ja taloudellista asemaa ennen rahamarkkinavälineen liikkeeseenlaskua;

1 kohdassa tarkoitetuista tiedoista säännöllisesti päivitetyt tiedot ja tiedot niissä tapahtuvista merkittävistä muutoksista;

olemassa olevat luotettavat tilastot liikkeeseenlaskusta tai liikkeeseenlaskuohjelmasta tai muut tiedot, joiden avulla voidaan arvioida tällaisiin rahamarkkinavälineisiin tehtyihin sijoituksiin liittyvät luottoriskit.
...
joka on sijoittunut Euroopan talousalueelle;

joka on sijoittunut G10-ryhmään kuuluvaan OECD-valtioon;

jolla on vähintään hyväksyttävän luottoluokituslaitoksen investointikelpoiseksi määrittelemä luottoluokitus (investment grade rating); tai

johon kohdistuvan arvioinnin perusteella voidaan osoittaa, että liikkeeseenlaskijaan sovellettavat toiminnan vakautta koskevat säännöt vastaavat Euroopan unionin lainsäädäntöä.
...
se mahdollistaa kohde-etuutena olevaan rahoitusvälineeseen liittyvän luottoriskin siirron erillään kohde-etuuteen liittyvistä muista riskeistä;

se ei johda muiden varojen kuin sijoitusrahastolain 13 luvun 2 §:n 1 momentissa, 4 ja 5 §:ssä, 6 §:n 1 ja 2 momentissa ja 15 §:ssä tarkoitettujen rahoitusvälineiden luovuttamiseen mukaan lukien sopimuksen toteuttaminen käteisellä;

se täyttää 3 ja 4 momentissa ja sijoitusrahastolain 13 luvun 15 §:ssä OTC-johdannaissopimukselle säädetyt vaatimukset;
...
se perustuu johdannaissopimuksen luotettavaan päivittäiseen markkina-arvoon tai jos sellaista ei ole saatavilla, riittävän tunnustettua menetelmää käyttävään hinnoittelumalliin;

sen todentaa:

OTC-johdannaissopimuksen vastapuolesta riippumaton ulkopuolinen taho tai osapuoli, joka tekee todennuksen riittävän usein ja siten, että rahastoyhtiö voi tarkistaa sen; tai

rahastoyhtiön varainhoidosta vastaavasta organisaation osasta riippumaton yksikkö tai muu organisaation osa, jolla on tarkoitukseen riittävät välineet.
...
indeksin koostumus on sellainen, että yhteen osaan kohdistuvat hintojen muutokset tai kaupankäynti eivät vaikuta merkittävästi koko indeksin kehitykseen;

jos indeksi koostuu sijoitusrahastolain 13 luvun 2 §:n 1 momentissa, 4 §:n 1 momentissa, 5 §:ssä, 6 §:n 1 ja 2 momentissa tai 15 §:ssä tarkoitetuista rahoitusvälineistä, se on hajautettu vähintään siten kuin sijoitusrahastolain 13 luvun 8 §:ssä säädetään;

jos indeksi koostuu muista kuin 2 kohdassa tarkoitetuista rahoitusvälineistä, se on hajautettu sijoitusrahastolain 13 luvun 8 §:ää vastaavalla tavalla.
...
indeksi mittaa kohde-etuuksista muodostuvan edustavan ryhmän kehitystä olennaisella ja asianmukaisella tavalla;

indeksiä tarkistetaan tai tasapainotetaan säännöllisesti julkisesti saatavilla olevien arviointiperusteiden avulla sen varmistamiseksi, että indeksi edelleen kuvaa viitemarkkinoitaan;

kohde-etuudet ovat niin helposti rahaksi muutettavat, että käyttäjät voivat tarvittaessa jäljitellä indeksiä.
...
indeksin julkistaminen perustuu luotettaviin menetelmiin hintojen keräämiseksi ja indeksiarvon laskemiseksi ja julkaisemiseksi ja se sisältää hinnoittelumenettelyt sellaisille osille, joille ei ole saatavilla markkinahintaa;

olennaiset tiedot, kuten tiedot indeksin laskemisesta, tasapainotusmenetelmistä, indeksien muutoksista tai mahdollisista vaikeuksista toimittaa ajoissa tarkkoja tietoja, ovat laajalti ja ajoissa saatavilla.
...
ne toteutetaan kustannustehokkaasti ja ovat taloudellisesti asianmukaisia;

niihin on tehty sijoitus riskin tai kustannusten pienentämiseksi taikka lisäpääoman tai lisätulojen muodostamiseksi siten, että riskitaso on sijoitusrahaston riskiprofiilin mukainen ja täyttää mainitun luvun 8 §:n vaatimukset riskien hajauttamisesta;

rahastoyhtiön riskienhallintajärjestelmässä otetaan huomioon niihin liittyvät riskit.
...
indeksi on riittävästi hajautettu, jos se täyttää mainitun pykälän hajauttamisvaatimukset;

indeksi kuvaa riittävän tarkasti markkinoita, joiden kehitystä sen on tarkoitus osoittaa, jos sen laatija käyttää tunnustettua menetelmää, joka ei yleensä johda merkittävän liikkeeseenlaskijan sulkemiseen indeksin kuvaamilta markkinoilta;

indeksistä on yleisesti saatavilla riittävät tiedot, jos se on yleisön käytettävissä ja indeksin laatija on riippumaton indeksiä jäljittelevästä rahastoyhtiöstä.
...
arvopapereita koskevat säännökset, joita sovelletaan rahasto-osuuteen ja siihen rinnastettavaan yhteissijoitusyrityksen osuuteen, säännökset tällaisten arvopaperien markkinoinnista ja markkinoinnin sisältöä koskevista vaatimuksista sekä säännökset rahoituspalvelujen ja rahoitusvälineiden etämyynnistä;

säännökset elinkeinotoiminnassa noudatettavaa menettelyä koskevista vaatimuksista;

Finanssivalvonnan toimenpidemaksusta annetut säännökset ja tiedot yhteissijoitusyritykseltä perittävistä maksuista;

Finanssivalvonnan sähköpostiosoite;

selostus 1–4 kohdassa tarkoitetuista tiedoista.
...
rahastoesitteestä annettu valtiovarainministeriön asetus (782/2000);

yhteissijoitusyrityksen saatavilla pidettävien tietojen laajuudesta annettu valtiovarainministeriön asetus (505/2012);

sijoitusrahastolain 11 luvussa tarkoitetuista rahoitusvälineistä annettu valtiovarainministeriön asetus (235/2014);

rahastoyhtiön ja säilytysyhteisön toimilupahakemukseen sekä sivuliikkeen perustamista ulkomaille koskevaan lupahakemukseen liitettävistä selvityksistä annettu valtiovarainministeriön asetus (437/2016); ja

rahastoesitteestä annettu valtiovarainministeriön asetus (438/2016).
