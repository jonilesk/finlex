...
yksi tai useampi hyvinvointialue lakkaa ja yhdistyy olemassa olevaan hyvinvointialueeseen;

hyvinvointialueet lakkaavat ja ne yhdistetään perustamalla uusi hyvinvointialue; taikka

hyvinvointialue jaetaan kahden tai useamman hyvinvointialueen kesken siten, että jaettava hyvinvointialue lakkaa.
...
hyvinvointialueen toiminnallisia ja taloudellisia edellytyksiä vastata palvelujen järjestämisestä ja tuottamisesta tai muuten edistää hyvinvointialueen toimintakykyä; taikka

hyvinvointialueen asukkaiden palveluja tai elinolosuhteita.
...
hyvinvointialueiden muuttamisen toteuttamistavasta ja ajankohdasta;

yhdistymisen perusteella syntyvän uuden hyvinvointialueen hallinnon järjestämisen periaatteista;

uuden hyvinvointialueen ja tarvittaessa uuden maakunnan nimestä;

yhdistyvien hyvinvointialueiden palvelujärjestelmien yhteensovittamisen periaatteista;

uuden hyvinvointialueen taloudenhoidon yleisistä periaatteista;

asukkaiden vaikuttamis- ja osallistumismahdollisuuksien toteuttamisen keinoista uudella hyvinvointialueella.
...
valtiovarainministeriön aloitteesta;

hyvinvointialueen tai kunnan esityksestä;

jos vähintään 20 prosenttia hyvinvointialueen äänioikeutetuista asukkaista tekee esityksen hyvinvointialueen muuttamista koskevan aluejakoselvityksen toimittamisesta;

hyvinvointialueesta annetun lain 122 §:ssä tarkoitetun arviointiryhmän esityksestä.
...
Hyvinvointialueiden nimistä ja alueista sekä maakuntajaosta tämän lain voimaan tullessa säädetään sosiaali- ja terveydenhuoltoa ja pelastustoimea koskevan uudistuksen toimeenpanosta ja sitä koskevan lainsäädännön voimaanpanosta annetussa laissa (616/2021).
