...
hän on täysi-ikäinen ja hänellä on oikeus harjoittaa elinkeinotoimintaa Suomessa;

hän ei ole konkurssissa eikä hänen toimintakelpoisuuttaan ole rajoitettu;

hänellä on 1 §:n 1 momentissa tarkoitetun valvonnan edellyttämä ammattitaito;

hän on luotettava; ja

hakijan 1 §:n 1 momentissa tarkoitettua valvontaa koskevaa järjestelmää voidaan pitää luotettavana.
...
sillä on palveluksessaan henkilö, joka vastaa siitä, että arvonlisäveron palautustoiminta on tämän lain mukaista, ja joka täyttää 1 momentin 1–4 kohdassa säädetyt edellytykset; ja
...
hakijana olevan luonnollisen henkilön täydellinen nimi, henkilötunnus tai sen puuttuessa syntymäaika, toiminimi, mahdollinen aputoiminimi, yritys- ja yhteisötunnus tai muu vastaava tunniste ja yhteystiedot;

hakijana olevan oikeushenkilön toiminimi, mahdollinen aputoiminimi, yritys- ja yhteisötunnus tai muu vastaava tunniste ja yhteystiedot;

hakijana olevan oikeushenkilön osalta 3 §:n 2 momentin 3 ja 4 kohdassa tarkoitettujen henkilöiden täydellinen nimi ja henkilötunnus tai sen puuttuessa syntymäaika;

1–3 kohdassa tarkoitetut tiedot jokaisen asiamiehen osalta;

jokaisen toimipisteen käyntiosoite ja tarkka sijainti;

selvitys 1 §:n 1 momentissa tarkoitetun valvontaa koskevan järjestelmän luotettavuudesta.
...
luonnollisen henkilön täydellinen nimi, toiminimi, mahdollinen aputoiminimi sekä yritys- ja yhteisötunnus tai muu vastaava tunniste;

oikeushenkilön toiminimi, mahdollinen aputoiminimi, yritys- ja yhteisötunnus tai muu vastaava tunniste sekä vastaavan hoitajan osalta 1 kohdassa tarkoitetut tiedot;

onko elinkeinonharjoittaja toimiluvanhaltija vai asiamies;
