tuotolla hankkeeseen tai toimintaan kohdistuvia sekä siitä välittömästi aiheutuvia tuloja myynnistä, vuokrauksesta, palveluista, maksuista ja muista vastaavista lähteistä;

mahdollistavilla edellytyksillä yleisasetuksen artiklan 15 mukaisia edellytyksiä;

tuloskehyksellä yleisasetuksen artiklan 16 mukaista kehystä;

erityistoimella turvapaikka-, maahanmuutto- ja kotouttamisrahastoasetuksen 18 artiklassa, sisäisen turvallisuuden rahastoasetuksen 15 artiklassa sekä rajaturvallisuuden ja viisumipolitiikan rahoitustukivälineasetuksen 15 artiklassa tarkoitettua toimenpidettä;

yhteisellä erityistoimella useamman kuin yhden valtion hanketta, johon yksi tai useampi jäsenvaltio voi saada erityistoimeen tarkoitettua rahoitusta ohjelmaansa;

toimintaa ohjaavalla valtiolla sitä valtiota, jonka ohjelmaan vastuu yhteisen erityistoimen toteuttamisesta on kirjattu ja jolle on osoitettu unionin talousarviosta ohjelmaan määräraha erityistoimen toteuttamista varten;

osallistuvalla valtiolla sitä valtiota, jonka ohjelmaan osallistuminen yhteisen erityistoimen toteuttamiseen on kirjattu;

päätoteuttajalla yhteisen erityistoimen käynnistämisestä ja täytäntöönpanosta vastaavaa julkisyhteisöä tai yksityisoikeudellista oikeushenkilöä;

osatoteuttajalla yhteisen erityistoimen täytäntöönpanoon osallistuvaa julkisyhteisöä tai yksityisoikeudellista oikeushenkilöä;

kirjanpitotoiminnolla yleisasetuksen 76 artiklan mukaista toimintoa;

siirron saajalla toimijaa, jolle avustuksen saaja siirtää edelleen osan hankkeen tai toiminnan avustuksesta.
...
ohjelman erityistavoitteiden mukaisesti toteutettavista toimista;

ohjelman toimeenpanon etenemisestä; ja

ohjelmaan sisältyvän rahoituksen tarkemmasta kohdentamisesta.
...
ohjelman ja toimeenpanosuunnitelman muuttamisesta, täytäntöönpanosta, hallinnoinnista ja arvioinnista;

kirjanpitotoiminnosta;

mahdollistavien edellytysten arvioinnista;

tuloskehyksen laatimisesta ja kehyksen määrittämismenetelmistä;

ohjelman vuotuisesta tuloksellisuuden tarkastelusta;

yleisasetuksen 39 artiklassa tarkoitetun seurantakomitean jäsenluettelon ja yleisasetuksen 69 artiklan 5 kohdan mukaisesti tietojen julkaisemisesta;

yleisasetuksen 69 artiklan 12 kohdan mukaisten sääntöjenvastaisuutta koskevien tietojen ilmoittamisesta;

yleisasetuksen liitteen VIII mukaisten arvioiden toimittamisesta;

yleisasetuksen liitteen XI mukaisten keskeisten vaatimusten täyttämisen varmistamisesta omalta osaltaan;

yleisasetuksen 69 artiklassa tarkoitetun seurantajärjestelmän ja indikaattoreita koskevien tietojen laadusta, oikeellisuudesta ja luotettavuudesta;

yleisasetuksen liitteen XIII mukaisten asiakirjojen säilyttämisestä;

tiedonvaihdosta komission kanssa yleisasetuksen liitteen XV mukaisesti;

yleisasetuksen liitteen XVI mukaisen hallinnointi- ja valvontajärjestelmän kuvauksen tekemisestä ja päivittämisestä;

muista kuin 1–13 kohdassa tarkoitetuista sille osoitetuista tehtävistä, joista säädetään Euroopan unionin sisäasioiden rahastoja koskevassa lainsäädännössä ja tässä laissa.
...
muista kuin 1 ja 2 kohdassa tarkoitetuista sille osoitetuista tehtävistä, joista Euroopan unionin sisäasioiden rahastoja koskevassa lainsäädännössä ja tässä laissa säädetään.
...
avustettava hanke tai toiminta on ohjelman ja toimeenpanosuunnitelman mukainen ja se edistää Euroopan unionin sisäasioiden rahastoja koskevassa lainsäädännössä, ohjelmassa ja toimeenpanosuunnitelmassa asetettuja tavoitteita;

avustettavan hankkeen tai toiminnan tarkoituksena on muu kuin taloudellisen edun tuottaminen avustuksen saajalle; ja

avustettava hanke tai toiminta täyttää seurantakomitean vahvistamat valinnassa käytettävät valintaperusteet.
