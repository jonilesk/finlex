...
voimankäyttövälineellä poliisista annetun valtioneuvoston asetuksen (1080/2013) 10 §:n 2 momentissa tarkoitettuja välineitä;

voimankäyttövälineen kantamisella sen hallussapitoa;

voimankäyttökoulutuksella voimankäyttövälineiden toiminnan, vaikutusten, käytön, niihin liittyvän taktiikan sekä fyysisen voimankäytön koulutusta;

tasokokeella testiä, jossa osoitetaan, että testattavalla on Poliisihallituksen määrittelemät tiedot ja taidot asianomaisen voimankäyttövälineen käyttöön;

kulkuneuvolla uhkaamisella pysäytettävän kulkuneuvon kiinteässä tuntumassa tapahtuvaa kulkuneuvolla seuraamista, tarkoituksena saada seurattavan kulkuneuvon kuljettaja luopumaan pakenemisesta;

piikkimatolla ajoradalle asetettavaa, piikeistä tai vastaavista kulkuneuvon renkaat rikkovista esineistä koostuvaa välinettä, jonka avulla pyritään pysäyttämään kulkuneuvo tai alentamaan sen nopeutta;

sululla kulkuneuvon ajoväylän kaventamista tai kulkusuunnan katkaisemista toisen kulkuneuvon avulla toimenpiteiden kohteena olevan kulkuneuvon nopeuden alentamiseksi tai sen ohjaamiseksi halutulle reitille;

edellä ajamisella kulkuneuvon etenemisen estämistä sen edessä ajamalla ja alentamalla ajonopeutta vähitellen;

kiilaamisella pakenemisen jatkumisen estämistä vaikuttamalla pysäytettävän kulkuneuvon ajolinjaan sivusuunnassa;

kiinniajamisella kulkuneuvon tavoittamista ja siihen liittyviä toimenpiteitä, joilla pyritään estämään pysäytettävän kulkuneuvon kulku;

esteellä kulkuneuvon reitille asetettua kulkuneuvoa taikka muuta esinettä tai rakennelmaa, jonka avulla pyritään estämään pysäytettävän kulkuneuvon kulku.
