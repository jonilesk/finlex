...
henkilön etsimiseksi tai kiinni ottamiseksi;

paikan tai alueen eristämiseksi tai tutkimiseksi sekä paikkaan, alueelle, rakennukseen, tilaan tai kulkuneuvoon pääsemiseksi;

liikenteen ohjaamiseksi;

henkilön tai omaisuuden tilapäiseksi suojaamiseksi;

räjähteen tunnistamiseksi tai siviiliräjähteen raivaamiseksi;

suuren tapahtuman tai yleisötilaisuuden suojaamiseksi;

kulkuneuvon, aluksen, ilma-aluksen tai miehittämättömän ilma-aluksen kulkuun puuttumiseksi tai sen pysäyttämiseksi;

kansainvälistä erityissuojelua nauttivan henkilön vierailun suojaamiseksi;

ihmisten hengelle tai terveydelle vakavaa vaaraa aiheuttavan rikoksen estämiseksi ja keskeyttämiseksi; sekä

kaluston, välineistön, tilojen tai Puolustusvoimien asiantuntija-avun luovuttamiseksi tilapäisesti poliisin käyttöön.
...
rikoslain (39/1889) 34 a luvun 1 §:n 1 momentin 2, 3 tai 5–8 kohdassa tai 2 momentissa tarkoitetun terrorismirikoksen estämiseksi tai keskeyttämiseksi; taikka
