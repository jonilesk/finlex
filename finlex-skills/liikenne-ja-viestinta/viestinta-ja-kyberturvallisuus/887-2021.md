...
EETS:llä eurooppalaista sähköistä tietullipalvelua, jota EETS-palveluntarjoaja tarjoaa EETS:n käyttäjälle yhdessä tai useammassa EETS-tietullikohteessa sopimuksen perusteella;
...
EETS-tietullikohteella sellaista tietä ja tieverkostoa, siltaa, tunnelia ja muuta rakennetta, sekä lossia, jossa tietulleja kerätään käyttäen sähköistä tietullijärjestelmää;
...
yhteentoimivuuden osatekijällä sellaista EETS:ään kuuluvan tai siihen liitettäväksi tarkoitetun laitteen perusosaa, osien ryhmää, osakokonaisuutta tai kokonaisuutta, josta palvelun yhteentoimivuus on suoraan tai epäsuorasti riippuvainen;
...
5,8 gigahertsin mikroaaltotekniikka.
...
EN ISO 9001 -sertifikaatti tai vastaava;

tarvittavat tekniset laitteet;

EY-vaatimustenmukaisuusvakuutus tai sertifikaatti, jolla todistetaan, että yhteentoimivuuden osatekijät ovat eritelmien mukaisia;

pätevyys sähköisten tietullipalvelujen tarjoamisessa tai muussa vastaavassa toiminnassa;

asianmukainen vakavaraisuus;

jatkuva ja kattava riskinhallintasuunnitelma, joka auditoidaan vähintään joka toinen vuosi;
...
tietullikohteesta vastaava tietullioperaattori;

käytetyt tietulliteknologiat;

tietullin perustiedot, joita ovat vastuullisen tietullioperaattorin määrittelemät tiedot, joita tarvitaan tietullin määrittämiseksi tietyssä tietullikohteessa liikkuvalle ajoneuvolle ja tietullitapahtuman suorittamiseksi;

EETS-tietullikohteen määritys;

ne EETS-palveluntarjoajat, jotka ovat tehneet sopimuksen tietullioperaattorin kanssa.
